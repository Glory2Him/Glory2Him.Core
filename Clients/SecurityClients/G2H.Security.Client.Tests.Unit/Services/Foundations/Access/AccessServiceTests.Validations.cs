...
namespace G2H.Security.Client.Tests.Unit.Services.Foundations.Access
{
    public partial class AccessServiceTests
    {
        ...
        {
            // given
            DismissReviewRequest? nullDismissReviewRequest = null;
            ...
            ValueTask<AccessVerdict> mayDismissApprovalReviewTask =
                this.accessService.MayDismissApprovalReviewAsync(nullDismissReviewRequest!);
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnMayDismissApprovalReviewIfActorIsNullAsync()
        {
            // given: an ungathered actor must be a validation error rather than a decision,
            // because a null actor would otherwise reach IsActorUsable and read as unauthenticated
            var requestWithoutActor = new DismissReviewRequest
            {
                Actor = null!,
                RoleSubjects = new List<RoleSubject>(),
            };
            ...
            invalidArgumentAccessException.UpsertDataList(
                key: nameof(DismissReviewRequest.Actor),
                value: "Actor is required");
            ...
            // when
            ValueTask<AccessVerdict> mayDismissApprovalReviewTask =
                this.accessService.MayDismissApprovalReviewAsync(requestWithoutActor);
        ...
        /// </summary>
        [Fact]
        public async Task ShouldThrowValidationExceptionOnMayDismissApprovalReviewIfRoleSubjectsIsNullAsync()
        {
            // given
            var requestWithoutRoleSubjects = new DismissReviewRequest
            {
                Actor = CreateRandomAccessActor(roles: new List<string> { RoleNames.Publisher }),
                RoleSubjects = null!,
            };
            ...
            invalidArgumentAccessException.UpsertDataList(
                key: nameof(DismissReviewRequest.RoleSubjects),
                value: "List is required");
            ...
            // when
            ValueTask<AccessVerdict> mayDismissApprovalReviewTask =
                this.accessService.MayDismissApprovalReviewAsync(requestWithoutRoleSubjects);
        ...
        /// <summary>
        /// The empty list is legal and must stay legal — but it admits nobody without a global
        /// role, which is the property the broker's fail-closed fallback leans on.
        /// </summary>
        [Fact]
        public async Task ShouldRefuseDismissingAReviewWhenRoleSubjectsIsEmptyAsync()
        {
            // given
            var requestWithNoSubjects = new DismissReviewRequest
            {
                Actor = CreateRandomAccessActor(
                    roles: new List<string> { RoleNames.PublisherFor("ContentItem") }),
            ...
            // when
            AccessVerdict actualVerdict =
                await this.accessService.MayDismissApprovalReviewAsync(requestWithNoSubjects);
