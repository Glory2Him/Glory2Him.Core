...
namespace Glory2Him.Core.Registrations
{
    ...
    {
        /// <summary>
        /// Registers the ContentItemSetting foundation service and its event handlers with the container.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public static IServiceCollection AddContentItemSettingService(this IServiceCollection services)
        {
            services.AddSingleton<IContentItemSettingService, ContentItemSettingService>();
