...
namespace Glory2Him.Core.Registrations
{
    ...
    {
        /// <summary>
        /// Registers the ApprovalSetting foundation service and its event handlers with the container.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public static IServiceCollection AddApprovalSettingService(this IServiceCollection services)
        {
            services.AddSingleton<IApprovalSettingService, ApprovalSettingService>();
