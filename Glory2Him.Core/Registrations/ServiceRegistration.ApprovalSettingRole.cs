...
namespace Glory2Him.Core.Registrations
{
    ...
    {
        /// <summary>
        /// Registers the ApprovalSettingRole foundation service and its event handlers with the container.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public static IServiceCollection AddApprovalSettingRoleService(this IServiceCollection services)
        {
            services.AddSingleton<IApprovalSettingRoleService, ApprovalSettingRoleService>();
