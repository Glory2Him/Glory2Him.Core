...
namespace Glory2Him.Core.Registrations
{
    ...
    {
        /// <summary>
        /// Registers the ContentItem orchestration service with the container.
        /// </summary>
        /// <remarks>
        /// Registered as a singleton to match the foundation services it composes (see
        /// <see cref="AddContentItemService"/>): future orchestration event subscriptions
        ...
        /// </remarks>
        public static IServiceCollection AddContentItemOrchestrationService(this IServiceCollection services)
        {
            services.AddSingleton<IContentItemOrchestrationService, ContentItemOrchestrationService>();
