...
namespace Glory2Him.Core.Registrations
{
    ...
    {
        /// <summary>
        /// Registers the ApprovalComment foundation service and its event handlers with the container.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public static IServiceCollection AddApprovalCommentService(this IServiceCollection services)
        {
            services.AddSingleton<IApprovalCommentService, ApprovalCommentService>();
