...
namespace Glory2Him.Core.Registrations
{
    ...
    {
        /// <summary>
        /// Registers the Reaction foundation service and its event handlers with the container.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public static IServiceCollection AddReactionService(this IServiceCollection services)
        {
