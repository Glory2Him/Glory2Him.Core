...
namespace Glory2Him.Core.Registrations
{
    ...
    {
        /// <summary>
        /// Registers the ApprovalSettingPublisherRole foundation service and its event handlers with the container.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public static IServiceCollection AddApprovalSettingPublisherRoleService(this IServiceCollection services)
        {
            services.AddSingleton<IApprovalSettingPublisherRoleService, ApprovalSettingPublisherRoleService>();
