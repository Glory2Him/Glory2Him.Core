...
namespace Glory2Him.Core.Registrations
{
    ...
    {
        /// <summary>
        /// Registers the ApprovalSettingReviewerRole foundation service and its event handlers with the container.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public static IServiceCollection AddApprovalSettingReviewerRoleService(this IServiceCollection services)
        {
            services.AddSingleton<IApprovalSettingReviewerRoleService, ApprovalSettingReviewerRoleService>();
