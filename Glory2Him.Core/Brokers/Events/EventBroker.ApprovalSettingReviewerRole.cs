...
namespace Glory2Him.Core.Brokers.Events
{
    ...
    {
        public ValueTask<EventPublishResult<ApprovalSettingReviewerRole>> PublishApprovalSettingReviewerRoleAsync(
            EventEnvelope<ApprovalSettingReviewerRole> envelope,
            ApprovalSettingReviewerRoleEventOperation operation) =>
                PublishEventAsync(
                    eventAddressIds: EventBrokerIdentifiers.ApprovalSettingReviewerRoleEventAddressIds,
                    entityName: nameof(ApprovalSettingReviewerRole),
                    envelope: envelope,
                    operation: operation);

        public ValueTask SubscribeToApprovalSettingReviewerRoleEventAsync(
            ...
            CancellationToken cancellationToken = default) =>
                SubscribeToEventAsync(
                    ...
                    operation: operation,
                    eventHandler: approvalSettingReviewerRoleEventHandler,
