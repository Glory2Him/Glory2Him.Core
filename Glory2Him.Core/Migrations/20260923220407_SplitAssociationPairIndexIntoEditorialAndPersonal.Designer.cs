...
namespace Glory2Him.Core.Migrations
{
    ...
    [Migration("20260923220407_SplitAssociationPairIndexIntoEditorialAndPersonal")]
    partial class SplitAssociationPairIndexIntoEditorialAndPersonal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Glory2Him.Core.Models.Foundations.ApprovalSettings.ApprovalSetting", b =>
                {
                    ...
                    b.Property<bool>("IsAIReviewerAutomaticallyRequested")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.HasIndex("EntityType", "IsPersonal")
                        .IsUnique()
                        .HasDatabaseName("UX_ApprovalSettings_AssociationPersonality")
                        .HasFilter("[IsPersonal] IS NOT NULL AND [IsDeleted] = 0");

                    b.HasIndex(new[] { "EntityType" }, "UX_ApprovalSettings_EntityTypeDefault")
                        .IsUnique()
                        .HasFilter("[EntityType] IS NOT NULL AND [ContentType] IS NULL AND [IsPersonal] IS NULL AND [IsDeleted] = 0");

                    b.HasIndex(new[] { "EntityType" }, "UX_ApprovalSettings_GlobalDefault")
                        .IsUnique()
                        .HasFilter("[EntityType] IS NULL AND [IsDeleted] = 0");
            ...
            modelBuilder.Entity("Glory2Him.Core.Models.Foundations.BibleReferences.BibleReference", b =>
                {
                    ...
                    b.Property<string>("ScriptureHtml")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Glory2Him.Core.Models.Foundations.ContentItems.ContentItem", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("EffectivePublishedWhen")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetimeoffset")
                        .HasComputedColumnSql("COALESCE([PublishDate], [CreatedWhen])", true);
            ...
            modelBuilder.Entity("Glory2Him.Core.Models.Foundations.AIReviewerAssignments.AIReviewerAssignment", b =>
                {
                    b.HasOne("Glory2Him.Core.Models.Foundations.Approvals.Approval", null)
                        .WithMany()
