...
namespace Glory2Him.Core.Models.Events
{
    ...
    /// example <c>ApprovalReview-Adding</c>) and composes the stored event name (for example
    /// <c>"ApprovalReviewAdding"</c>). Entity-specific operations may be appended here (with a
