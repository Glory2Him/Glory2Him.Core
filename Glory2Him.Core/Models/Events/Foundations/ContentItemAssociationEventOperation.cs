...
namespace Glory2Him.Core.Models.Events.Foundations
{
    ...
    /// example <c>ContentItemAssociation-Adding</c>) and composes the stored event name (for example
    /// <c>"ContentItemAssociationAdding"</c>). Entity-specific operations may be appended here (with a
