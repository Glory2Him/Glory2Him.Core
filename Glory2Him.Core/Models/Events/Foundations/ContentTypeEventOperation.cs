...
namespace Glory2Him.Core.Models.Events.Foundations
{
    ...
    /// <c>ContentType-Adding</c>) and composes the stored event name (for example
    /// <c>"ContentTypeAdding"</c>). <see cref="HardRemoved"/> shares the
    /// <see cref="Removed"/> event address and is distinguished purely by its event name
    /// (<c>"ContentTypeHardRemoved"</c>). Entity-specific operations may be appended here
