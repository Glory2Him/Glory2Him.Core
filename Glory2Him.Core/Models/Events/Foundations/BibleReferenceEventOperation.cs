...
namespace Glory2Him.Core.Models.Events.Foundations
{
    ...
    /// <c>BibleReference-Adding</c>) and composes the stored event name (for example
    /// <c>"BibleReferenceAdding"</c>). <see cref="HardRemoved"/> shares the
    /// <see cref="Removed"/> event address and is distinguished purely by its event name
    /// (<c>"BibleReferenceHardRemoved"</c>). Entity-specific operations may be appended here
