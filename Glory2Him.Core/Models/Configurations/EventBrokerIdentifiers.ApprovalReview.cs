...
namespace Glory2Him.Core.Models.Configurations
{
    public static partial class EventBrokerIdentifiers
    {
        ...
        internal static readonly IReadOnlyDictionary<ApprovalReviewEventOperation, Guid> ApprovalReviewEventAddressIds =
            new Dictionary<ApprovalReviewEventOperation, Guid>
            {
