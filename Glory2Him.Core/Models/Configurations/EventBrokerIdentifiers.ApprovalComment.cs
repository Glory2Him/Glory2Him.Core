...
namespace Glory2Him.Core.Models.Configurations
{
    public static partial class EventBrokerIdentifiers
    {
        ...
        internal static readonly IReadOnlyDictionary<ApprovalCommentEventOperation, Guid> ApprovalCommentEventAddressIds =
            new Dictionary<ApprovalCommentEventOperation, Guid>
            {
