...
namespace Glory2Him.Core.Models.Configurations
{
    public static partial class EventBrokerIdentifiers
    {
        ...
        internal static readonly IReadOnlyDictionary<ApprovalSettingRoleEventOperation, Guid> ApprovalSettingRoleEventAddressIds =
            new Dictionary<ApprovalSettingRoleEventOperation, Guid>
            {
