...
namespace Glory2Him.Core.Models.Configurations
{
    public static partial class EventBrokerIdentifiers
    {
        ...
        internal static readonly IReadOnlyDictionary<ApprovalSettingEventOperation, Guid>
            ApprovalSettingEventAddressIds = new Dictionary<ApprovalSettingEventOperation, Guid>
            {
