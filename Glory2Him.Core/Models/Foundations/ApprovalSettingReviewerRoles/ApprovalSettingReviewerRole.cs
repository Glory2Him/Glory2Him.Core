...
namespace Glory2Him.Core.Models.Foundations.ApprovalSettingReviewerRoles
{
    /// <summary>
    /// Defines a role that is permitted to approve or reject for a given <see cref="ApprovalSetting"/>.
    /// </summary>
    public class ApprovalSettingReviewerRole : IKey, IAudit
    {
        /// <summary>
        ...
        /// <summary>
        /// The name of the role permitted to approve or reject.
        /// </summary>
