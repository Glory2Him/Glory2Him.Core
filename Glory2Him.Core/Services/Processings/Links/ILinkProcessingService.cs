...
namespace Glory2Him.Core.Services.Processings.Links
{
    public partial interface ILinkProcessingService
    {
        ...
        /// authenticated and not blocked by the <c>ReadOnly</c> or <c>Link-ReadOnly</c>
        ...
        /// <c>LinkProcessing-Added</c> completion fact, distinct from the
        /// foundation's row-level <c>Link-Added</c>.
        /// </summary>
        ...
        /// already-exists validation error. A single <c>LinkProcessing-Modified</c>
        ...
        /// service publishes <c>LinkProcessing-Removed</c>.
        /// </summary>
        ...
        /// <see cref="RetrieveAllLinksAsync"/> would widen the set with the caller's
        ...
        /// <see cref="RetrieveAllLinksAsync"/>: deleted rows are gone for everyone,
