...
namespace Glory2Him.Core.Services.Foundations.Links
{
    internal partial interface ILinkService
    {
        ...
        /// <see cref="FindPublishedLinkIdByGroupAsync(System.Guid, System.Guid,
        ...
        /// <summary>
        /// The publication swap's route into <see cref="FindPublishedLinkIdByGroupAsync(
        ...
        /// </summary>
        internal ValueTask<Guid?> FindPublishedLinkIdByGroupAsync(
            Guid groupId,
            Guid excludedLinkId,
            EventEnvelope<Link> inboundEnvelope,
            CancellationToken cancellationToken = default);
