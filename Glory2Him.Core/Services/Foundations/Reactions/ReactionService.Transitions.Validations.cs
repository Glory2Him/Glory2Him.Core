...
namespace Glory2Him.Core.Services.Foundations.Reactions
{
    internal partial class ReactionService
    {
        ...
        private static void ValidateOnTransitionReactionApproval(Reaction reaction) =>
            Validate(
                message: "Reaction is invalid, fix the errors and try again.",
                ...
                (Rule: IsNotAnApprovalTransitionTarget(reaction.ApprovalStatus),
                ...
                (Rule: IsBypassWithoutApproval(
                        reaction.IsApprovedByBypass, reaction.ApprovalStatus),
                ...
                (Rule: IsMissingBypassReason(
                        reaction.IsApprovedByBypass, reaction.ApprovedByBypassReason),
                ...
                // field at all.
                (Rule: IsGreaterThan(reaction.ApprovedByBypassReason, 500),
                    Parameter: nameof(Reaction.ApprovedByBypassReason)));
        ...
        private async ValueTask<bool> ValidateUserCanTransitionStorageReactionApprovalAsync(
            Reaction storageReaction,
            Reaction reaction,
            SecurityContext securityContext,
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (isSystemIdentity)
            {
                return reaction.IsApprovedByBypass;
            }
            ...
            AccessVerdict verdict = await this.accessBroker.MayDecideApprovalAsync(
                new ApprovalDecisionQuery
                {
                    ...
                    IsSubjectDeleted = storageReaction.IsDeleted,
        ...
        private static void ValidateStorageReactionIsTransitionable(
            Reaction storageReaction)
        {
        ...
        private static dynamic IsBypassWithoutApproval(
            ...
            ApprovalStatus approvalStatus) => new
            {
                ...
                Message = "Bypass requires an approved reaction."
            };
