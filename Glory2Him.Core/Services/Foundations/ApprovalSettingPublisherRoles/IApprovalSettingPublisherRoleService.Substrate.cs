...
namespace Glory2Him.Core.Services.Foundations.ApprovalSettingPublisherRoles
{
    ...
    public partial interface IApprovalSettingPublisherRoleService
    {
        ...
        ValueTask<EventEnvelope<ApprovalSettingPublisherRole>?> OnModifyingApprovalSettingPublisherRoleAsync(
            EventEnvelope<ApprovalSettingPublisherRole> envelope,
            CancellationToken cancellationToken = default);

        ValueTask<EventEnvelope<ApprovalSettingPublisherRole>?> OnRemovingApprovalSettingPublisherRoleByIdAsync(
            EventEnvelope<ApprovalSettingPublisherRole> envelope,
            CancellationToken cancellationToken = default);

        ValueTask<EventEnvelope<ApprovalSettingPublisherRole>?> OnHardRemovingApprovalSettingPublisherRoleByIdAsync(
            EventEnvelope<ApprovalSettingPublisherRole> envelope,
            CancellationToken cancellationToken = default);

        ValueTask<EventEnvelope<ApprovalSettingPublisherRole>?> OnRetrievingApprovalSettingPublisherRoleByIdAsync(
            EventEnvelope<ApprovalSettingPublisherRole> envelope,
            CancellationToken cancellationToken = default);
    }
}
