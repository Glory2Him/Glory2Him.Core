...
namespace Glory2Him.Core.Services.Foundations.ApprovalSettingPublisherRoles
{
    ...
    /// causation chain.
    /// </summary>
    public partial class ApprovalSettingPublisherRoleService : IApprovalSettingPublisherRoleService
    {
        ...
        public ValueTask<ApprovalSettingPublisherRole> AddApprovalSettingPublisherRoleAsync(
            ...
            TryCatch(async () =>
            {
                ...
                EventEnvelope<ApprovalSettingPublisherRole> envelope =
                    await this.eventEnvelopeFactory.CreateAsync(content: approvalSettingPublisherRole);
