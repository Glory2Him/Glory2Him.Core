...
namespace Glory2Him.Core.Services.Foundations.BibleReferences
{
    internal partial class BibleReferenceService
    {
        ...
        private static void ValidateOnTransitionBibleReferenceApproval(BibleReference bibleReference) =>
            Validate(
                message: "Bible reference is invalid, fix the errors and try again.",
                ...
                (Rule: IsNotAnApprovalTransitionTarget(bibleReference.ApprovalStatus),
                ...
                (Rule: IsBypassWithoutApproval(
                        bibleReference.IsApprovedByBypass, bibleReference.ApprovalStatus),
                ...
                (Rule: IsMissingBypassReason(
                        bibleReference.IsApprovedByBypass, bibleReference.ApprovedByBypassReason),
                ...
                // field at all.
                (Rule: IsGreaterThan(bibleReference.ApprovedByBypassReason, 500),
                    Parameter: nameof(BibleReference.ApprovedByBypassReason)));
        ...
        private async ValueTask<bool> ValidateUserCanTransitionStorageBibleReferenceApprovalAsync(
            BibleReference storageBibleReference,
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (isSystemIdentity)
            {
                return bibleReference.IsApprovedByBypass;
            }
            ...
            if (bibleReference.ApprovalStatus == ApprovalStatus.Submitted)
            {
                return false;
            }
            ...
            AccessVerdict verdict = await this.accessBroker.MayDecideApprovalAsync(
                new ApprovalDecisionQuery
                {
                    ...
                    IsSubjectDeleted = storageBibleReference.IsDeleted,
                    ...
                    IsBypassRequested = bibleReference.IsApprovedByBypass,
                    BypassReason = bibleReference.ApprovedByBypassReason,
        ...
        private static void ValidateStorageBibleReferenceIsTransitionable(
            BibleReference storageBibleReference)
        {
        ...
        private static dynamic IsBypassWithoutApproval(
            ...
            ApprovalStatus approvalStatus) => new
            {
                ...
                Message = "Bypass requires an approved bible reference."
            };
