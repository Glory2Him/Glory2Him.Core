...
namespace Glory2Him.Core.Services.Foundations.BibleReferences
{
    ...
    internal partial class BibleReferenceService
    {
        ...
        public ValueTask<BibleReference> ApproveBibleReferenceAsync(
            ...
            TryCatch(async () =>
            {
                ...
                return await DoApproveBibleReferenceAsync(
                    bibleReference: bibleReference,
                    inboundEnvelope: envelope,
                    cancellationToken: cancellationToken);
            });
        ...
        private async ValueTask<BibleReference> DoApproveBibleReferenceAsync(
            BibleReference bibleReference,
            EventEnvelope<BibleReference> inboundEnvelope,
            CancellationToken cancellationToken)
        {
            ValidateUserIsAllowedToContribute(inboundEnvelope.SecurityContext);
            ValidateOnApproveBibleReference(bibleReference);
            ...
            AccessVerdict accessVerdict = await ValidateUserCanApproveStorageBibleReferenceAsync(
                storageBibleReference: storageBibleReference,
                bibleReference: bibleReference,
                securityContext: inboundEnvelope.SecurityContext,
                cancellationToken: cancellationToken);

            ValidateStorageBibleReferenceIsApprovable(storageBibleReference);
            ...
            storageBibleReference.IsPublished = bibleReference.IsPublished;
            storageBibleReference.PublishDate = bibleReference.PublishDate;
            ...
            storageBibleReference.IsApprovedByBypass = accessVerdict.IsBypassUsed;
            ...
            BibleReferenceEventOperation decision =
