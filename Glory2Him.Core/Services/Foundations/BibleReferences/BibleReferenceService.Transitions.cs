...
namespace Glory2Him.Core.Services.Foundations.BibleReferences
{
    ...
    /// <c>DoModifyBibleReferenceAsync</c> in one important way: the row is loaded FIRST and the caller's
    ...
    {
        public ValueTask<BibleReference> SubmitBibleReferenceByIdAsync(
            ...
            TryCatch(async () =>
            {
                ...
                var submitRequest = new BibleReference { Id = bibleReferenceId };

                EventEnvelope<BibleReference> envelope =
                    await this.eventEnvelopeBroker.CreateAsync(content: submitRequest);

                return await DoSubmitBibleReferenceAsync(
                    bibleReferenceId: bibleReferenceId,
                    inboundEnvelope: envelope,
                    cancellationToken: cancellationToken);
            });

        public ValueTask<BibleReference> TransitionBibleReferenceApprovalAsync(
            ...
            TryCatch(async () =>
            {
                ...
                return await DoTransitionBibleReferenceApprovalAsync(
                    bibleReference: bibleReference,
                    inboundEnvelope: envelope,
        ...
        private async ValueTask<BibleReference> DoSubmitBibleReferenceAsync(
            Guid bibleReferenceId,
            EventEnvelope<BibleReference> inboundEnvelope,
            CancellationToken cancellationToken)
        {
            ValidateUserIsAllowedToContribute(inboundEnvelope.SecurityContext);
            ValidateOnSubmitBibleReference(bibleReferenceId);
            ...
            // the caller supplied
            await ValidateUserCanSubmitStorageBibleReferenceAsync(
                storageBibleReference: storageBibleReference,
                securityContext: inboundEnvelope.SecurityContext);

            ValidateStorageBibleReferenceIsSubmittable(storageBibleReference);
            ...
            storageBibleReference.ApprovalStatus = ApprovalStatus.Submitted;
        ...
        private async ValueTask<BibleReference> DoTransitionBibleReferenceApprovalAsync(
            BibleReference bibleReference,
            EventEnvelope<BibleReference> inboundEnvelope,
            ...
            CancellationToken cancellationToken)
        {
            ...
            bool isBypassUsed = await ValidateUserCanTransitionStorageBibleReferenceApprovalAsync(
                storageBibleReference: storageBibleReference,
                bibleReference: bibleReference,
                securityContext: inboundEnvelope.SecurityContext,
            ...
            ValidateStorageBibleReferenceIsTransitionable(storageBibleReference);
            ...
            storageBibleReference.ApprovalStatus = bibleReference.ApprovalStatus;
            ...
            bool isApproved = bibleReference.ApprovalStatus == ApprovalStatus.Approved;
            storageBibleReference.IsPublished = isApproved && bibleReference.IsPublished;
            storageBibleReference.PublishDate = storageBibleReference.IsPublished ? bibleReference.PublishDate : null;
            ...
            storageBibleReference.IsApprovedByBypass = isBypassUsed;

            storageBibleReference.ApprovedByBypassReason = isBypassUsed
                ? bibleReference.ApprovedByBypassReason
                : null;
            ...
            BibleReferenceEventOperation decision = bibleReference.ApprovalStatus switch
            {
                ApprovalStatus.Approved => BibleReferenceEventOperation.Approved,
                ApprovalStatus.Rejected => BibleReferenceEventOperation.Rejected,
                _ => BibleReferenceEventOperation.Submitted
            };
        ...
        private async ValueTask<BibleReference> LoadTransitionTargetAsync(
            Guid bibleReferenceId,
            CancellationToken cancellationToken)
        {
            BibleReference maybeBibleReference =
                await this.storageBroker.SelectBibleReferenceByIdAsync(
                    bibleReferenceId: bibleReferenceId,
                    cancellationToken: cancellationToken);
            ...
            ValidateStorageBibleReferenceIsNotDeleted(maybeBibleReference, bibleReferenceId);
        ...
        private async ValueTask<BibleReference> SaveTransitionAsync(
            BibleReference bibleReference,
            EventEnvelope<BibleReference> inboundEnvelope,
            ...
            CancellationToken cancellationToken)
        {
            ...
            BibleReference updatedBibleReference =
                await this.storageBroker.UpdateBibleReferenceAsync(
                    bibleReference,
                    cancellationToken);
            ...
            EventPublishResult<BibleReference> publishResult =
