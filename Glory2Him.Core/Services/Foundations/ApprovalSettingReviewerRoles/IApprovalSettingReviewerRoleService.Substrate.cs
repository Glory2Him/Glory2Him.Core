...
namespace Glory2Him.Core.Services.Foundations.ApprovalSettingReviewerRoles
{
    ...
    {
        ValueTask<EventEnvelope<ApprovalSettingReviewerRole>?> OnAddingApprovalSettingReviewerRoleAsync(
            EventEnvelope<ApprovalSettingReviewerRole> envelope,
            CancellationToken cancellationToken = default);

        ValueTask<EventEnvelope<ApprovalSettingReviewerRole>?> OnModifyingApprovalSettingReviewerRoleAsync(
            EventEnvelope<ApprovalSettingReviewerRole> envelope,
            CancellationToken cancellationToken = default);

        ValueTask<EventEnvelope<ApprovalSettingReviewerRole>?> OnRemovingApprovalSettingReviewerRoleByIdAsync(
            EventEnvelope<ApprovalSettingReviewerRole> envelope,
            CancellationToken cancellationToken = default);

        ValueTask<EventEnvelope<ApprovalSettingReviewerRole>?> OnHardRemovingApprovalSettingReviewerRoleByIdAsync(
            EventEnvelope<ApprovalSettingReviewerRole> envelope,
            CancellationToken cancellationToken = default);

        ValueTask<EventEnvelope<ApprovalSettingReviewerRole>?> OnRetrievingApprovalSettingReviewerRoleByIdAsync(
            EventEnvelope<ApprovalSettingReviewerRole> envelope,
            CancellationToken cancellationToken = default);
    }
}
