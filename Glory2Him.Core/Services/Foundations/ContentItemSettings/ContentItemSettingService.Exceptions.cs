...
namespace Glory2Him.Core.Services.Foundations.ContentItemSettings
{
    internal partial class ContentItemSettingService
    {
            ...
            ReturningContentItemSettingEventEnvelopeFunction returningContentItemSettingEventEnvelopeFunction)
        {
            ...
            catch (UnauthorizedContentItemSettingException unauthorizedContentItemSettingException)
            {
                throw await CreateAndLogValidationExceptionAsync(exception: unauthorizedContentItemSettingException);
            }
            ...
            catch (DuplicateKeyWithUniqueIndexException duplicateKeyWithUniqueIndexException)
            {
                ...
                throw await CreateAndLogDependencyValidationExceptionAsync(
                    alreadyExistsContentItemSettingException);
            }
