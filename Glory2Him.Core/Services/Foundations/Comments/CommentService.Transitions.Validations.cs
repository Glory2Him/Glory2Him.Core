...
namespace Glory2Him.Core.Services.Foundations.Comments
{
    internal partial class CommentService
    {
        ...
        private static void ValidateOnApproveComment(Comment comment) =>
            Validate(
                message: "Comment is invalid, fix the errors and try again.",
                ...
                (Rule: IsNotAnApprovalOutcome(comment.ApprovalStatus),
        ...
        private async ValueTask<AccessVerdict> ValidateUserCanApproveStorageCommentAsync(
            Comment storageComment,
            Comment comment,
            SecurityContext securityContext,
        ...
        private static void ValidateStorageCommentIsApprovable(
            Comment storageComment)
        {
            if (storageComment.ApprovalStatus != ApprovalStatus.Submitted)
            {
