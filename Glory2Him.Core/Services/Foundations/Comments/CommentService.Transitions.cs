...
namespace Glory2Him.Core.Services.Foundations.Comments
{
    ...
    internal partial class CommentService
    {
        ...
        public ValueTask<Comment> TransitionCommentApprovalAsync(
            Comment comment,
            CancellationToken cancellationToken = default) =>
            TryCatch(async () =>
            {
                ...
                return await DoTransitionCommentApprovalAsync(
                    comment: comment,
                    inboundEnvelope: envelope,
        ...
        private async ValueTask<Comment> DoTransitionCommentApprovalAsync(
            Comment comment,
            EventEnvelope<Comment> inboundEnvelope,
            ...
            CancellationToken cancellationToken)
        {
            ...
            ValidateOnTransitionCommentApproval(comment);
            ...
            bool isBypassUsed = await ValidateUserCanTransitionStorageCommentApprovalAsync(
                storageComment: storageComment,
                comment: comment,
                securityContext: inboundEnvelope.SecurityContext,
            ...
            ValidateStorageCommentIsTransitionable(storageComment);
            ...
            bool isApproved = comment.ApprovalStatus == ApprovalStatus.Approved;
            storageComment.IsPublished = isApproved && comment.IsPublished;
            storageComment.PublishDate = storageComment.IsPublished ? comment.PublishDate : null;
            ...
            storageComment.IsApprovedByBypass = isBypassUsed;

            storageComment.ApprovedByBypassReason = isBypassUsed
                ? comment.ApprovedByBypassReason
                : null;
            ...
            CommentEventOperation decision = comment.ApprovalStatus switch
            {
                ApprovalStatus.Approved => CommentEventOperation.Approved,
                ApprovalStatus.Rejected => CommentEventOperation.Rejected,
                _ => CommentEventOperation.Submitted
            };
