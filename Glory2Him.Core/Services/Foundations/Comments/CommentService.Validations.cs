...
namespace Glory2Him.Core.Services.Foundations.Comments
{
    internal partial class CommentService
    {
        ...
        // here but by ValidateStorageCommentIsNotTerminal on the same path — which reads the
        ...
        private static void ValidateStorageCommentIsNotTerminal(Comment storageComment)
        {
            bool isTerminal =
