...
namespace Glory2Him.Core.Services.Foundations.ApprovalSettingRoles
{
    ...
    /// one per request address (<c>ApprovalSettingRole-Adding</c>, <c>-Modifying</c>,
    ...
    {
        public ValueTask<EventEnvelope<ApprovalSettingRole>?> OnAddingApprovalSettingRoleAsync(
            EventEnvelope<ApprovalSettingRole> envelope,
            CancellationToken cancellationToken = default) =>
            TryCatchSubstrate(async () =>
            {
                cancellationToken.ThrowIfCancellationRequested();
                ValidateApprovalSettingRoleEventEnvelope(envelope);
                ...
                ApprovalSettingRole addedApprovalSettingRole = await DoAddApprovalSettingRoleAsync(
                    approvalSettingRole: envelope.Content,
        ...
        public ValueTask<EventEnvelope<ApprovalSettingRole>?> OnModifyingApprovalSettingRoleAsync(
            EventEnvelope<ApprovalSettingRole> envelope,
            CancellationToken cancellationToken = default) =>
            TryCatchSubstrate(async () =>
            {
                ...
                ApprovalSettingRole modifiedApprovalSettingRole = await DoModifyApprovalSettingRoleAsync(
                    approvalSettingRole: envelope.Content,
                    inboundEnvelope: envelope,
                    cancellationToken: cancellationToken);
                ...
                return await this.eventEnvelopeFactory.CreateNextAsync(
                    sourceEnvelope: envelope,
                    content: modifiedApprovalSettingRole);
            });

        public ValueTask<EventEnvelope<ApprovalSettingRole>?> OnRemovingApprovalSettingRoleByIdAsync(
            EventEnvelope<ApprovalSettingRole> envelope,
            CancellationToken cancellationToken = default) =>
            TryCatchSubstrate(async () =>
            {
                ...
                ApprovalSettingRole removedApprovalSettingRole = await DoRemoveApprovalSettingRoleByIdAsync(
                    approvalSettingRoleId: envelope.Content.Id,
        ...
        public ValueTask<EventEnvelope<ApprovalSettingRole>?> OnHardRemovingApprovalSettingRoleByIdAsync(
            EventEnvelope<ApprovalSettingRole> envelope,
            CancellationToken cancellationToken = default) =>
            TryCatchSubstrate(async () =>
            {
                ...
                ApprovalSettingRole deletedApprovalSettingRole = await DoHardRemoveApprovalSettingRoleByIdAsync(
                    approvalSettingRoleId: envelope.Content.Id,
                    inboundEnvelope: envelope,
                    cancellationToken: cancellationToken);
        ...
        public ValueTask<EventEnvelope<ApprovalSettingRole>?> OnRetrievingApprovalSettingRoleByIdAsync(
            EventEnvelope<ApprovalSettingRole> envelope,
            CancellationToken cancellationToken = default) =>
            TryCatchSubstrate(async () =>
            {
                ...
                ApprovalSettingRole retrievedApprovalSettingRole = await RetrieveApprovalSettingRoleByIdAsync(
                    approvalSettingRoleId: envelope.Content.Id,
                    cancellationToken: cancellationToken);

                return await this.eventEnvelopeFactory.CreateNextAsync(
                    sourceEnvelope: envelope,
                    content: retrievedApprovalSettingRole);
            });
