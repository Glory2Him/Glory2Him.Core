...
namespace Glory2Him.Core.Services.Orchestrations.AIReviewers
{
    internal partial class AIReviewerOrchestrationService
    {
        ...
        private async ValueTask ValidateApprovalFactEnvelopeAsync(
            ...
            string eventName)
        {
            // AHEAD OF THE VERIFY, matching the pattern criterion 3 names. The integrity broker
            // reads envelope?.Integrity, so a null envelope already answers false — but a signed
