...
const defaultRows: ReadonlyArray<ComponentPropRow> = [
    ...
    },
    {
        ...
        description: 'Off is the safe posture: read-only, except that a contributor may still withdraw their own unapproved reference. Switch it on for a moderation surface to add Reject and Approve, gated by moderationRoles.'
    }
];
