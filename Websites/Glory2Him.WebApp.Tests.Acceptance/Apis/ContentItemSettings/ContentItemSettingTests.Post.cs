...
namespace Glory2Him.WebApp.Tests.Acceptance.Apis.ContentItemSettings
{
    public partial class ContentItemSettingApiTests
    {
        ...
        public async Task ShouldPostContentItemSettingAsync()
        {
            ...
            {
                // when
                await this.apiBroker.PostContentItemSettingAsync(inputContentItemSetting);

                ContentItemSetting actualContentItemSetting =
                    await this.apiBroker.GetContentItemSettingByIdAsync(inputContentItemSetting.Id);
