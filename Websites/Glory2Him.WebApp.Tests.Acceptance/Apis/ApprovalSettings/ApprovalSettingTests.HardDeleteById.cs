...
namespace Glory2Him.WebApp.Tests.Acceptance.Apis.ApprovalSettings
{
    ...
    {
        [Fact]
        public async Task ShouldHardDeleteApprovalSettingByIdAsync()
        {
            // given
            ...
            try
            {
                ...
                ApprovalSetting deletedApprovalSetting =
                    await this.apiBroker.HardDeleteApprovalSettingByIdAsync(inputApprovalSetting.Id);

                List<ApprovalSetting> actualResult =
                    await this.apiBroker.GetSpecificApprovalSettingByIdAsync(inputApprovalSetting.Id);
