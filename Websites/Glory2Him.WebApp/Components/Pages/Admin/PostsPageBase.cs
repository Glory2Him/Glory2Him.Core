...
namespace Glory2Him.WebApp.Components.Pages.Admin
{
    public class PostsPageBase : ComponentBase
    {
        ...
        protected void CreatePost() =>
            Navigation.NavigateTo($"{PostDetailPageBase.PostsRoute}/New");

        protected void EditPost(string postId) =>
            Navigation.NavigateTo($"{PostDetailPageBase.PostsRoute}/{postId}");
    }
}
