...
{
    public partial class BlogSidebarComponent
    {
        [Parameter]
        public IReadOnlyList<PostView> TrendingPosts { get; set; } =
            new List<PostView>();

        [Parameter]
        public IReadOnlyList<string> Topics { get; set; } =
            new List<string> { "Faith", "Hope", "Prayer", "Scripture", "Testimony", "Worship" };
