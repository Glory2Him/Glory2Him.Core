    ...
    public partial class ContentItemsControllerTests
    {
        ...
        public async Task ShouldReturnRecordOnGetByIdsAsync()
        {
            ...
            contentItemProcessingServiceMock
                .Setup(service => service.RetrieveContentItemByIdAsync(
                    It.IsAny<Guid>(),
            ...
            ActionResult<ContentItem> actualActionResult =
                await contentItemsController.GetContentItemByIdAsync(randomContentItem.Id, TestContext.Current.CancellationToken);

            // then
            actualActionResult.ShouldBeEquivalentTo(expectedActionResult);

            contentItemProcessingServiceMock
                .Verify(service => service.RetrieveContentItemByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
