...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ContentItems
{
    ...
    {
        [Fact]
        public void GetFeedShouldAllowAnonymous()
        {
            // Given
            var controllerType = typeof(ContentItemsController);
            var methodInfo = controllerType.GetMethod(nameof(ContentItemsController.GetContentItemFeed));
        ...
        [Fact]
        public void GetFeedShouldNotHaveRoleAttributeWithRoles()
        {
            // Given
            var controllerType = typeof(ContentItemsController);
            var methodInfo = controllerType.GetMethod(nameof(ContentItemsController.GetContentItemFeed));
