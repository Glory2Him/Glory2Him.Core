    ...
    public partial class ContentItemsControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnGetByIdIfValidationErrorOccurredAsync(Xeption validationException)
        {
            ...
            this.contentItemProcessingServiceMock.Setup(service =>
                service.RetrieveContentItemByIdAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
                    .ThrowsAsync(validationException);

            // when
            ActionResult<ContentItem> actualActionResult =
                await this.contentItemsController.GetContentItemByIdAsync(someId, TestContext.Current.CancellationToken);
