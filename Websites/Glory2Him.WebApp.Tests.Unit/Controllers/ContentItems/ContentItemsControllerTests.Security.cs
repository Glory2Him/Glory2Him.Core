...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ContentItems
{
    public partial class ContentItemsControllerTests
    {
        ...
        public void EveryActionShouldBeAccountedForBySecurityTests()
        {
            ...
            {
                nameof(ContentItemsController.PostContentItemAsync),
                nameof(ContentItemsController.Get),
                nameof(ContentItemsController.GetContentItemByIdAsync),
