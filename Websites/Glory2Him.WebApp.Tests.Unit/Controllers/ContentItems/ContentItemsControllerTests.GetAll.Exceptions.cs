    ...
    public partial class ContentItemsControllerTests
    {
            ...
            Xeption serverException)
        {
            ...
            var expectedActionResult =
                new ActionResult<IQueryable<ContentItem>>(expectedInternalServerErrorObjectResult);
            ...
            ActionResult<IQueryable<ContentItem>> actualActionResult =
                await this.contentItemsController.Get(TestContext.Current.CancellationToken);
            ...
            Xeption dependencyException)
        {
            ...
            var expectedActionResult =
                new ActionResult<IQueryable<ContentItem>>(expectedFailedDependencyObjectResult);
