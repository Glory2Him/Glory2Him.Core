    ...
    public partial class ApprovalSettingsControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnPutIfValidationErrorOccurredAsync(Xeption validationException)
        {
            ...
            this.approvalSettingServiceMock.Setup(service =>
                service.ModifyApprovalSettingAsync(It.IsAny<ApprovalSetting>(), It.IsAny<CancellationToken>()))
                    .ThrowsAsync(validationException);

            // when
            ActionResult<ApprovalSetting> actualActionResult =
                await this.approvalSettingsController.PutApprovalSettingAsync(someApprovalSetting, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldReturnConflictOnPutIfAlreadyExistsApprovalSettingErrorOccurredAsync()
        {
            // given
            ApprovalSetting someApprovalSetting = CreateRandomApprovalSetting();
