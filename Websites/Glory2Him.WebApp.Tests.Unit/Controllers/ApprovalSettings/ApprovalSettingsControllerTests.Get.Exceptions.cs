    ...
    public partial class ApprovalSettingsControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnGetByIdIfValidationErrorOccurredAsync(Xeption validationException)
        {
            ...
            this.approvalSettingServiceMock.Setup(service =>
                service.RetrieveApprovalSettingByIdAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
                    .ThrowsAsync(validationException);

            // when
            ActionResult<ApprovalSetting> actualActionResult =
                await this.approvalSettingsController.GetApprovalSettingByIdAsync(someId, TestContext.Current.CancellationToken);
