...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ApprovalSettings
{
    public partial class ApprovalSettingsControllerTests
    {
        ...
        {
            // Given
            var controllerType = typeof(ApprovalSettingsController);
        ...
        public void EveryActionShouldBeAccountedForBySecurityTests()
        {
            ...
            {
                nameof(ApprovalSettingsController.PostApprovalSettingAsync),
                nameof(ApprovalSettingsController.Get),
                nameof(ApprovalSettingsController.GetApprovalSettingByIdAsync),
                nameof(ApprovalSettingsController.PutApprovalSettingAsync),
                nameof(ApprovalSettingsController.DeleteApprovalSettingByIdAsync),
                nameof(ApprovalSettingsController.HardDeleteApprovalSettingByIdAsync)
            };
        ...
        private static List<MethodInfo> GetActions() =>
            typeof(ApprovalSettingsController)
