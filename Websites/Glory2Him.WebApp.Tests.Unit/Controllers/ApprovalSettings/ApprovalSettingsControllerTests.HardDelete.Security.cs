...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ApprovalSettings
{
    ...
    {
        [Fact]
        public void HardDeleteShouldHaveRoleAttributeWithRoles()
        {
            // Given
            var controllerType = typeof(ApprovalSettingsController);
            var methodInfo = controllerType.GetMethod("HardDeleteApprovalSettingByIdAsync");
        ...
        [Fact]
        public void HardDeleteShouldNotAllowAnonymous()
        {
            // Given
            var controllerType = typeof(ApprovalSettingsController);
            var methodInfo = controllerType.GetMethod("HardDeleteApprovalSettingByIdAsync");
