...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ApprovalSettings
{
    public partial class ApprovalSettingsControllerTests
    {
        ...
        public async Task ShouldReturnOkOnPutAsync()
        {
            ...
            ApprovalSetting storageApprovalSetting = inputApprovalSetting.DeepClone();
            ...
            approvalSettingServiceMock
                .Setup(service => service.ModifyApprovalSettingAsync(inputApprovalSetting, It.IsAny<CancellationToken>()))
            ...
            approvalSettingServiceMock
               .Verify(service => service.ModifyApprovalSettingAsync(inputApprovalSetting, It.IsAny<CancellationToken>()),
                   Times.Once);
