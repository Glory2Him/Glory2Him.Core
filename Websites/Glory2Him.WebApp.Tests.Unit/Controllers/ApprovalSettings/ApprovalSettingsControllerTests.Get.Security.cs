...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ApprovalSettings
{
    ...
    {
        [Fact]
        public void GetShouldNotAllowAnonymous()
        {
            // Given
            var controllerType = typeof(ApprovalSettingsController);
            var methodInfo = controllerType.GetMethod("GetApprovalSettingByIdAsync");
        ...
        [Fact]
        public void GetShouldRequireAuthenticationWithoutRoles()
        {
            // Given
            var controllerType = typeof(ApprovalSettingsController);
            var methodInfo = controllerType.GetMethod("GetApprovalSettingByIdAsync");
