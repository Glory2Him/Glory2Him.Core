...
using Glory2Him.WebApp.Controllers.ApprovalSettings;
using Moq;
...
{
    public partial class ApprovalSettingsControllerTests : RESTFulController
    {
        private readonly Mock<IApprovalSettingService> approvalSettingServiceMock;
        private readonly ApprovalSettingsController approvalSettingsController;

        public ApprovalSettingsControllerTests()
        {
            approvalSettingServiceMock = new Mock<IApprovalSettingService>();
            approvalSettingsController = new ApprovalSettingsController(approvalSettingServiceMock.Object);
        }
        ...
        public static TheoryData<Xeption> ServerExceptions()
        {
            ...
            return new TheoryData<Xeption>
            {
                new ApprovalSettingServiceException(
                    message: someMessage,
                    innerException: someInnerException)
            };
        }
