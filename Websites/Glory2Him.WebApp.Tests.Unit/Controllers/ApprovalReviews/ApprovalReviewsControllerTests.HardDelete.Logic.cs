    ...
    public partial class ApprovalReviewsControllerTests
    {
        ...
        public async Task ShouldRemoveRecordOnHardDeleteByIdsAsync()
        {
            ...
            approvalReviewServiceMock
                .Setup(service => service.HardRemoveApprovalReviewByIdAsync(
                    It.IsAny<Guid>(),
            ...
            ActionResult<ApprovalReview> actualActionResult =
                await approvalReviewsController.HardDeleteApprovalReviewByIdAsync(
            ...
            approvalReviewServiceMock
                .Verify(service => service.HardRemoveApprovalReviewByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
