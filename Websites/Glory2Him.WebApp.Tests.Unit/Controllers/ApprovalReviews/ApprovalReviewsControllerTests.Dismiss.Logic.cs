...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ApprovalReviews
{
    ...
    {
        [Fact]
        public async Task ShouldReturnOkOnDismissAsync()
        {
            // given
            ...
            ActionResult<ApprovalReview> actualActionResult =
                await approvalReviewsController.DismissApprovalReviewAsync(
            ...
            approvalReviewServiceMock
                .Verify(service => service.DismissApprovalReviewAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
