...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ApprovalReviews
{
    ...
    {
        [Fact]
        public void DismissShouldHaveRoleAttributeWithRoles()
        {
            // Given
            var controllerType = typeof(ApprovalReviewsController);
            var methodInfo = controllerType.GetMethod("DismissApprovalReviewAsync");
        ...
        [Fact]
        public void DismissShouldNotAllowAnonymous()
        {
            // Given
            var controllerType = typeof(ApprovalReviewsController);
            var methodInfo = controllerType.GetMethod("DismissApprovalReviewAsync");
