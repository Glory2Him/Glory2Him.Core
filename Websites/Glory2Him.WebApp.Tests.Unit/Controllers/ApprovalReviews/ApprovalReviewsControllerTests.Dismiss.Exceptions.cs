...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ApprovalReviews
{
    public partial class ApprovalReviewsControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnDismissIfValidationErrorOccurredAsync(
            Xeption validationException)
        {
            ...
            ActionResult<ApprovalReview> actualActionResult =
                await this.approvalReviewsController.DismissApprovalReviewAsync(someId, default);
        ...
        public async Task ShouldReturnInternalServerErrorOnDismissIfServerErrorOccurredAsync(
        ...
        [Fact]
        public async Task ShouldReturnNotFoundOnDismissIfItemDoesNotExistAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
        ...
        [Fact]
        public async Task ShouldReturnUnauthorizedOnDismissIfUnauthorizedErrorOccurredAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
            string someMessage = GetRandomString();
        ...
        [Fact]
        public async Task ShouldReturnConflictOnDismissIfAlreadyExistsApprovalReviewErrorOccurredAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
        ...
        [Fact]
        public async Task ShouldReturnLockedOnDismissIfRecordIsLockedAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
            var someInnerException = new Exception();
        ...
        public async Task ShouldReturnFailedDependencyOnDismissIfDependencyErrorOccurredAsync(
