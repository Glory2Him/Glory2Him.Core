...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ApprovalComments
{
    public partial class ApprovalCommentsControllerTests
    {
        ...
        {
            // Given
            var controllerType = typeof(ApprovalCommentsController);
        ...
        public void EveryActionShouldBeAccountedForBySecurityTests()
        {
            ...
            {
                nameof(ApprovalCommentsController.PostApprovalCommentAsync),
                nameof(ApprovalCommentsController.Get),
                nameof(ApprovalCommentsController.GetApprovalCommentByIdAsync),
                nameof(ApprovalCommentsController.PutApprovalCommentAsync),
                nameof(ApprovalCommentsController.DeleteApprovalCommentByIdAsync),
                nameof(ApprovalCommentsController.HardDeleteApprovalCommentByIdAsync),
                nameof(ApprovalCommentsController.ResolveApprovalCommentAsync)
            };
        ...
        private static List<MethodInfo> GetActions() =>
            typeof(ApprovalCommentsController)
