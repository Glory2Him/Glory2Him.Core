    ...
    public partial class ApprovalCommentsControllerTests
    {
            ...
            Xeption validationException)
        {
            ...
            this.approvalCommentServiceMock.Setup(service =>
                service.AddApprovalCommentAsync(
            ...
            ActionResult<ApprovalComment> actualActionResult =
                await this.approvalCommentsController.PostApprovalCommentAsync(someApprovalComment, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldReturnConflictOnPostIfAlreadyExistsApprovalCommentErrorOccurredAsync()
        {
            // given
            ApprovalComment someApprovalComment = CreateRandomApprovalComment();
        ...
        [Fact]
        public async Task ShouldReturnLockedOnPostIfRecordIsLockedAsync()
        {
            // given
            ApprovalComment someApprovalComment = CreateRandomApprovalComment();
            var someInnerException = new Exception();
