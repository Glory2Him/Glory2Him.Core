...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ApprovalComments
{
    public partial class ApprovalCommentsControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnResolveIfValidationErrorOccurredAsync(
            Xeption validationException)
        {
            ...
            this.approvalCommentServiceMock.Setup(service =>
                service.ResolveApprovalCommentAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<bool>(),
            ...
            ActionResult<ApprovalComment> actualActionResult =
                await this.approvalCommentsController.ResolveApprovalCommentAsync(someId, isResolved: true, TestContext.Current.CancellationToken);
        ...
        public async Task ShouldReturnInternalServerErrorOnResolveIfServerErrorOccurredAsync(
        ...
        [Fact]
        public async Task ShouldReturnNotFoundOnResolveIfItemDoesNotExistAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
        ...
        [Fact]
        public async Task ShouldReturnUnauthorizedOnResolveIfUnauthorizedErrorOccurredAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
            string someMessage = GetRandomString();
        ...
        [Fact]
        public async Task ShouldReturnConflictOnResolveIfAlreadyExistsApprovalCommentErrorOccurredAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
        ...
        [Fact]
        public async Task ShouldReturnLockedOnResolveIfRecordIsLockedAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
            var someInnerException = new Exception();
        ...
        public async Task ShouldReturnFailedDependencyOnResolveIfDependencyErrorOccurredAsync(
