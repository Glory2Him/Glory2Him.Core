    ...
    public partial class ApprovalCommentsControllerTests
    {
        ...
        public async Task ShouldRemoveRecordOnDeleteByIdsAsync()
        {
            ...
            approvalCommentServiceMock
                .Setup(service => service.RemoveApprovalCommentByIdAsync(
                    It.IsAny<Guid>(),
                    inputDeletionReason,
            ...
            ActionResult<ApprovalComment> actualActionResult =
                await approvalCommentsController.DeleteApprovalCommentByIdAsync(
            ...
            approvalCommentServiceMock
                .Verify(service => service.RemoveApprovalCommentByIdAsync(
                    It.IsAny<Guid>(),
                    inputDeletionReason,
                    It.IsAny<CancellationToken>()),
                        Times.Once);
