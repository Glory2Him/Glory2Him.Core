...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ApprovalComments
{
    ...
    {
        [Fact]
        public async Task ShouldReturnOkOnResolveAsync()
        {
            // given
            ...
            bool inputIsResolved = GetRandomBoolean();
            ...
            approvalCommentServiceMock
                .Setup(service => service.ResolveApprovalCommentAsync(
                    It.IsAny<Guid>(),
                    inputIsResolved,
            ...
            approvalCommentServiceMock
                .Verify(service => service.ResolveApprovalCommentAsync(
                    It.IsAny<Guid>(),
                    inputIsResolved,
                    It.IsAny<CancellationToken>()),
                        Times.Once);
