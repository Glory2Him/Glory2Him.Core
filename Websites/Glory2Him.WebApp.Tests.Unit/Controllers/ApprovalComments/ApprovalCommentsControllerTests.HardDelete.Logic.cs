    ...
    public partial class ApprovalCommentsControllerTests
    {
        ...
        public async Task ShouldRemoveRecordOnHardDeleteByIdsAsync()
        {
            ...
            approvalCommentServiceMock
                .Setup(service => service.HardRemoveApprovalCommentByIdAsync(
                    It.IsAny<Guid>(),
            ...
            ActionResult<ApprovalComment> actualActionResult =
                await approvalCommentsController.HardDeleteApprovalCommentByIdAsync(
            ...
            approvalCommentServiceMock
                .Verify(service => service.HardRemoveApprovalCommentByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
