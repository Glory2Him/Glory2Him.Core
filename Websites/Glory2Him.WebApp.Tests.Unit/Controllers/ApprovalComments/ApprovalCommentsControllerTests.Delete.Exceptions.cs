    ...
    public partial class ApprovalCommentsControllerTests
    {
            ...
            Xeption validationException)
        {
            ...
            this.approvalCommentServiceMock.Setup(service =>
                service.RemoveApprovalCommentByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<string>(),
            ...
            ActionResult<ApprovalComment> actualActionResult =
                await this.approvalCommentsController.DeleteApprovalCommentByIdAsync(someId, null, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldReturnConflictOnDeleteIfAlreadyExistsApprovalCommentErrorOccurredAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
