...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ApprovalComments
{
    ...
    {
        [Fact]
        public void ResolveShouldHaveRoleAttributeWithRoles()
        {
            // Given
            var controllerType = typeof(ApprovalCommentsController);
            var methodInfo = controllerType.GetMethod("ResolveApprovalCommentAsync");
        ...
        [Fact]
        public void ResolveShouldNotAllowAnonymous()
        {
            // Given
            var controllerType = typeof(ApprovalCommentsController);
            var methodInfo = controllerType.GetMethod("ResolveApprovalCommentAsync");
