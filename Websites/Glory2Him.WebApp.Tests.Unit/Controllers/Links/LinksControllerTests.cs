...
{
    public partial class LinksControllerTests : RESTFulController
    {
        ...
        {
            linkProcessingServiceMock = new Mock<ILinkProcessingService>();
            linksController = new LinksController(linkProcessingServiceMock.Object);
        }
