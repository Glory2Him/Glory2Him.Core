    ...
    public partial class LinksControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnDeleteIfValidationErrorOccurredAsync(Xeption validationException)
        {
            ...
            ActionResult<Link> actualActionResult =
                await this.linksController.DeleteLinkByIdAsync(someId, null, TestContext.Current.CancellationToken);
            ...
            Xeption dependencyException)
        {
            ...
            this.linkProcessingServiceMock.Setup(service =>
                service.RemoveLinkByIdAsync(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
