...
using Glory2Him.WebApp.Controllers.Links;
...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Links
{
    public partial class LinksControllerTests
    {
        ...
        {
            // Given
            var controllerType = typeof(LinksController);
        ...
        public void EveryActionShouldBeAccountedForBySecurityTests()
        {
            ...
            {
                nameof(LinksController.PostLinkAsync),
                nameof(LinksController.Get),
                nameof(LinksController.GetLinkByIdAsync),
                nameof(LinksController.PutLinkAsync),
                nameof(LinksController.DeleteLinkByIdAsync),
                nameof(LinksController.GetPublicLinks),
                nameof(LinksController.GetLinksByGroupId),
                nameof(LinksController.GetLatestLinkByGroupIdAsync),
                nameof(LinksController.GetPublishedLinkByGroupIdAsync)
            };
