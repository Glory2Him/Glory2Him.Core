...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Links
{
    ...
    {
        [Fact]
        public async Task ShouldReturnLinkOnGetLatestByGroupAsync()
        {
            // given
            ...
            linkProcessingServiceMock
                .Setup(service => service.RetrieveLatestLinkByGroupIdAsync(inputGroupId, It.IsAny<CancellationToken>()))
            ...
            linkProcessingServiceMock
                .Verify(service => service.RetrieveLatestLinkByGroupIdAsync(inputGroupId, It.IsAny<CancellationToken>()),
                    Times.Once);
