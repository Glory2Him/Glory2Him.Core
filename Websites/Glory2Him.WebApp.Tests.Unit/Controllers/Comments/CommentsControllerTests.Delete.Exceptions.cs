    ...
    public partial class CommentsControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnDeleteIfValidationErrorOccurredAsync(Xeption validationException)
        {
            ...
            this.commentServiceMock.Setup(service =>
                service.RemoveCommentByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<string>(),
            ...
            ActionResult<Comment> actualActionResult =
                await this.commentsController.DeleteCommentByIdAsync(someId, null, TestContext.Current.CancellationToken);
            ...
            Xeption dependencyException)
        {
            ...
            this.commentServiceMock.Setup(service =>
                service.RemoveCommentByIdAsync(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
        ...
        [Fact]
        public async Task ShouldReturnConflictOnDeleteIfAlreadyExistsCommentErrorOccurredAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
            var someInnerException = new Exception();
            ...
            this.commentServiceMock.Setup(service =>
                service.RemoveCommentByIdAsync(It.IsAny<Guid>(),
                    It.IsAny<string>(),
                    It.IsAny<CancellationToken>()))
                    .ThrowsAsync(commentDependencyValidationException);
