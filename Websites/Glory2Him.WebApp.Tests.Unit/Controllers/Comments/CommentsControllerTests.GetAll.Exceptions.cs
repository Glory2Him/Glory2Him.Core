    ...
    public partial class CommentsControllerTests
    {
            ...
            Xeption serverException)
        {
            ...
            var expectedActionResult =
                new ActionResult<IQueryable<Comment>>(expectedInternalServerErrorObjectResult);
            ...
            ActionResult<IQueryable<Comment>> actualActionResult =
                await this.commentsController.Get(TestContext.Current.CancellationToken);
            ...
            Xeption dependencyException)
        {
            ...
            var expectedActionResult =
                new ActionResult<IQueryable<Comment>>(expectedFailedDependencyObjectResult);
