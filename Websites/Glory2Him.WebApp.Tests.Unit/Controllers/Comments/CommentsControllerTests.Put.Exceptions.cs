    ...
    public partial class CommentsControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnPutIfValidationErrorOccurredAsync(Xeption validationException)
        {
            ...
            this.commentServiceMock.Setup(service =>
                service.ModifyCommentAsync(It.IsAny<Comment>(), It.IsAny<CancellationToken>()))
        ...
        [Fact]
        public async Task ShouldReturnConflictOnPutIfAlreadyExistsCommentErrorOccurredAsync()
        {
            // given
            Comment someComment = CreateRandomComment();
