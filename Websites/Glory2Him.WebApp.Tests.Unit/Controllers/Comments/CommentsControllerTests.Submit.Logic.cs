...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Comments
{
    public partial class CommentsControllerTests
    {
        ...
        public async Task ShouldReturnOkOnSubmitAsync()
        {
            ...
            commentServiceMock
                .Setup(service => service.SubmitCommentByIdAsync(
                    It.IsAny<Guid>(),
            ...
            ActionResult<Comment> actualActionResult =
                await commentsController.SubmitCommentByIdAsync(randomComment.Id, TestContext.Current.CancellationToken);

            // then
            actualActionResult.ShouldBeEquivalentTo(expectedActionResult);

            commentServiceMock
                .Verify(service => service.SubmitCommentByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
