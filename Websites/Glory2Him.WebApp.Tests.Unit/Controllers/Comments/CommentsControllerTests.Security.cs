...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Comments
{
    public partial class CommentsControllerTests
    {
        ...
        public void EveryActionShouldBeAccountedForBySecurityTests()
        {
            ...
            {
                nameof(CommentsController.PostCommentAsync),
                nameof(CommentsController.Get),
                nameof(CommentsController.GetCommentByIdAsync),
                nameof(CommentsController.PutCommentAsync),
                nameof(CommentsController.DeleteCommentByIdAsync),
                nameof(CommentsController.HardDeleteCommentByIdAsync),
                nameof(CommentsController.SubmitCommentByIdAsync),
                nameof(CommentsController.TransitionCommentApprovalAsync)
            };
