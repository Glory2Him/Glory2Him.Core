...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Comments
{
    public partial class CommentsControllerTests
    {
        ...
        public async Task ShouldReturnOkOnPutAsync()
        {
            ...
            commentServiceMock
                .Setup(service => service.ModifyCommentAsync(inputComment, It.IsAny<CancellationToken>()))
            ...
            commentServiceMock
               .Verify(service => service.ModifyCommentAsync(inputComment, It.IsAny<CancellationToken>()),
                   Times.Once);
