    ...
    public partial class BibleReferencesControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnPutIfValidationErrorOccurredAsync(Xeption validationException)
        {
            ...
            this.bibleReferenceServiceMock.Setup(service =>
                service.ModifyBibleReferenceAsync(It.IsAny<BibleReference>(), It.IsAny<CancellationToken>()))
                    .ThrowsAsync(validationException);

            // when
            ActionResult<BibleReference> actualActionResult =
                await this.bibleReferencesController.PutBibleReferenceAsync(someBibleReference, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldReturnConflictOnPutIfAlreadyExistsBibleReferenceErrorOccurredAsync()
        {
            // given
            BibleReference someBibleReference = CreateRandomBibleReference();
