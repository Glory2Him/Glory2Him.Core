    ...
    public partial class BibleReferencesControllerTests
    {
            ...
            Xeption validationException)
        {
            ...
            this.bibleReferenceServiceMock.Setup(service =>
                service.SubmitBibleReferenceByIdAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
                    .ThrowsAsync(validationException);

            // when
            ActionResult<BibleReference> actualActionResult =
                await this.bibleReferencesController.SubmitBibleReferenceByIdAsync(someId, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldReturnConflictOnSubmitIfAlreadyExistsBibleReferenceErrorOccurredAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
            var someInnerException = new Exception();
