    ...
    public partial class BibleReferencesControllerTests
    {
            ...
            Xeption validationException)
        {
            ...
            this.bibleReferenceServiceMock.Setup(service =>
                service.TransitionBibleReferenceApprovalAsync(It.IsAny<BibleReference>(), It.IsAny<CancellationToken>()))
                    .ThrowsAsync(validationException);

            // when
            ActionResult<BibleReference> actualActionResult =
                await this.bibleReferencesController.TransitionBibleReferenceApprovalAsync(someBibleReference, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldReturnConflictOnApproveIfAlreadyExistsBibleReferenceErrorOccurredAsync()
        {
            // given
            BibleReference someBibleReference = CreateRandomBibleReference();
            var someInnerException = new Exception();
