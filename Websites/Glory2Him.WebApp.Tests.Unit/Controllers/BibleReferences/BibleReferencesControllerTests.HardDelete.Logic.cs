    ...
    public partial class BibleReferencesControllerTests
    {
        ...
        public async Task ShouldRemoveRecordOnHardDeleteByIdsAsync()
        {
            ...
            bibleReferenceServiceMock
                .Setup(service => service.HardRemoveBibleReferenceByIdAsync(
                    It.IsAny<Guid>(),
            ...
            ActionResult<BibleReference> actualActionResult =
                await bibleReferencesController.HardDeleteBibleReferenceByIdAsync(randomBibleReference.Id, TestContext.Current.CancellationToken);

            // then
            actualActionResult.ShouldBeEquivalentTo(expectedActionResult);

            bibleReferenceServiceMock
                .Verify(service => service.HardRemoveBibleReferenceByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
