...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.BibleReferences
{
    ...
    {
        [Fact]
        public void SubmitShouldHaveRoleAttributeWithRoles()
        {
            // Given
            var controllerType = typeof(BibleReferencesController);
            var methodInfo = controllerType.GetMethod("SubmitBibleReferenceByIdAsync");
        ...
        [Fact]
        public void SubmitShouldNotAllowAnonymous()
        {
            // Given
            var controllerType = typeof(BibleReferencesController);
            var methodInfo = controllerType.GetMethod("SubmitBibleReferenceByIdAsync");
