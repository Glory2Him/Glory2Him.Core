    ...
    public partial class BibleReferencesControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnDeleteIfValidationErrorOccurredAsync(Xeption validationException)
        {
            ...
            this.bibleReferenceServiceMock.Setup(service =>
                service.RemoveBibleReferenceByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<string>(),
            ...
            ActionResult<BibleReference> actualActionResult =
                await this.bibleReferencesController.DeleteBibleReferenceByIdAsync(someId, null, TestContext.Current.CancellationToken);
            ...
            Xeption dependencyException)
        {
            ...
            this.bibleReferenceServiceMock.Setup(service =>
                service.RemoveBibleReferenceByIdAsync(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
        ...
        [Fact]
        public async Task ShouldReturnConflictOnDeleteIfAlreadyExistsBibleReferenceErrorOccurredAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
            var someInnerException = new Exception();
            ...
            this.bibleReferenceServiceMock.Setup(service =>
                service.RemoveBibleReferenceByIdAsync(It.IsAny<Guid>(),
                    It.IsAny<string>(),
                    It.IsAny<CancellationToken>()))
                    .ThrowsAsync(bibleReferenceDependencyValidationException);
