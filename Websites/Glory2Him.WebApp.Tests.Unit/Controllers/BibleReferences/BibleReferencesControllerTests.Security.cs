...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.BibleReferences
{
    public partial class BibleReferencesControllerTests
    {
        ...
        {
            // Given
            var controllerType = typeof(BibleReferencesController);
        ...
        public void EveryActionShouldBeAccountedForBySecurityTests()
        {
            ...
            {
                nameof(BibleReferencesController.PostBibleReferenceAsync),
                nameof(BibleReferencesController.Get),
                nameof(BibleReferencesController.GetBibleReferenceByIdAsync),
                nameof(BibleReferencesController.PutBibleReferenceAsync),
                nameof(BibleReferencesController.DeleteBibleReferenceByIdAsync),
                nameof(BibleReferencesController.HardDeleteBibleReferenceByIdAsync),
                nameof(BibleReferencesController.SubmitBibleReferenceByIdAsync),
                nameof(BibleReferencesController.TransitionBibleReferenceApprovalAsync)
            };
        ...
        private static List<MethodInfo> GetActions() =>
            typeof(BibleReferencesController)
