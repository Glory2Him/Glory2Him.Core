...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.BibleReferences
{
    ...
    {
        [Fact]
        public async Task ShouldReturnOkOnSubmitAsync()
        {
            // given
            ...
            bibleReferenceServiceMock
                .Setup(service => service.SubmitBibleReferenceByIdAsync(
                    It.IsAny<Guid>(),
            ...
            ActionResult<BibleReference> actualActionResult =
                await bibleReferencesController.SubmitBibleReferenceByIdAsync(randomBibleReference.Id, TestContext.Current.CancellationToken);

            // then
            actualActionResult.ShouldBeEquivalentTo(expectedActionResult);

            bibleReferenceServiceMock
                .Verify(service => service.SubmitBibleReferenceByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
