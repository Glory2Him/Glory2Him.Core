...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Reactions
{
    public partial class ReactionsControllerTests
    {
        ...
        public async Task ShouldReturnOkOnApproveAsync()
        {
            ...
            // when
            ActionResult<Reaction> actualActionResult = await reactionsController.TransitionReactionApprovalAsync(randomReaction, TestContext.Current.CancellationToken);
