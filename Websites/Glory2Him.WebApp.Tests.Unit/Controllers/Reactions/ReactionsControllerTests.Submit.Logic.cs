...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Reactions
{
    public partial class ReactionsControllerTests
    {
        ...
        public async Task ShouldReturnOkOnSubmitAsync()
        {
            ...
            reactionServiceMock
                .Setup(service => service.SubmitReactionByIdAsync(
                    It.IsAny<Guid>(),
            ...
            ActionResult<Reaction> actualActionResult =
                await reactionsController.SubmitReactionByIdAsync(randomReaction.Id, TestContext.Current.CancellationToken);

            // then
            actualActionResult.ShouldBeEquivalentTo(expectedActionResult);

            reactionServiceMock
                .Verify(service => service.SubmitReactionByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
