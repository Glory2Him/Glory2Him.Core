...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Reactions
{
    public partial class ReactionsControllerTests
    {
        ...
        {
            // Given
            var controllerType = typeof(ReactionsController);
        ...
        public void EveryActionShouldBeAccountedForBySecurityTests()
        {
            ...
            {
                nameof(ReactionsController.PostReactionAsync),
                nameof(ReactionsController.Get),
                nameof(ReactionsController.GetReactionByIdAsync),
                nameof(ReactionsController.PutReactionAsync),
                nameof(ReactionsController.DeleteReactionByIdAsync),
                nameof(ReactionsController.HardDeleteReactionByIdAsync),
                nameof(ReactionsController.SubmitReactionByIdAsync),
                nameof(ReactionsController.TransitionReactionApprovalAsync)
            };
