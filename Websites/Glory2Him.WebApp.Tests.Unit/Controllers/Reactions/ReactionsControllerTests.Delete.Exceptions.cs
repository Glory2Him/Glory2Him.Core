    ...
    public partial class ReactionsControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnDeleteIfValidationErrorOccurredAsync(Xeption validationException)
        {
            ...
            this.reactionServiceMock.Setup(service =>
                service.RemoveReactionByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<string>(),
            ...
            ActionResult<Reaction> actualActionResult =
                await this.reactionsController.DeleteReactionByIdAsync(someId, null, TestContext.Current.CancellationToken);
            ...
            Xeption dependencyException)
        {
            ...
            this.reactionServiceMock.Setup(service =>
                service.RemoveReactionByIdAsync(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
        ...
        [Fact]
        public async Task ShouldReturnConflictOnDeleteIfAlreadyExistsReactionErrorOccurredAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
            var someInnerException = new Exception();
            ...
            this.reactionServiceMock.Setup(service =>
                service.RemoveReactionByIdAsync(It.IsAny<Guid>(),
                    It.IsAny<string>(),
                    It.IsAny<CancellationToken>()))
                    .ThrowsAsync(reactionDependencyValidationException);
