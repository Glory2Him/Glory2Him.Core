    ...
    public partial class ReactionsControllerTests
    {
            ...
            Xeption validationException)
        {
            ...
            this.reactionServiceMock.Setup(service =>
                service.TransitionReactionApprovalAsync(It.IsAny<Reaction>(), It.IsAny<CancellationToken>()))
        ...
        [Fact]
        public async Task ShouldReturnConflictOnApproveIfAlreadyExistsReactionErrorOccurredAsync()
        {
            // given
            Reaction someReaction = CreateRandomReaction();
            var someInnerException = new Exception();
