    ...
    public partial class ContentItemSettingsControllerTests
    {
        ...
        public async Task ShouldRemoveRecordOnHardDeleteByIdsAsync()
        {
            ...
            contentItemSettingServiceMock
                .Setup(service => service.HardRemoveContentItemSettingByIdAsync(
                    It.IsAny<Guid>(),
            ...
            ActionResult<ContentItemSetting> actualActionResult =
                await contentItemSettingsController.HardDeleteContentItemSettingByIdAsync(randomContentItemSetting.Id, TestContext.Current.CancellationToken);

            // then
            actualActionResult.ShouldBeEquivalentTo(expectedActionResult);

            contentItemSettingServiceMock
                .Verify(service => service.HardRemoveContentItemSettingByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
