    ...
    public partial class ContentItemSettingsControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnPutIfValidationErrorOccurredAsync(Xeption validationException)
        {
            ...
            this.contentItemSettingServiceMock.Setup(service =>
                service.ModifyContentItemSettingAsync(It.IsAny<ContentItemSetting>(), It.IsAny<CancellationToken>()))
                    .ThrowsAsync(validationException);

            // when
            ActionResult<ContentItemSetting> actualActionResult =
                await this.contentItemSettingsController.PutContentItemSettingAsync(someContentItemSetting, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldReturnConflictOnPutIfAlreadyExistsContentItemSettingErrorOccurredAsync()
        {
            // given
            ContentItemSetting someContentItemSetting = CreateRandomContentItemSetting();
