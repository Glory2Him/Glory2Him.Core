...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.ContentItemSettings
{
    public partial class ContentItemSettingsControllerTests
    {
        ...
        public void EveryActionShouldBeAccountedForBySecurityTests()
        {
            ...
            {
                nameof(ContentItemSettingsController.PostContentItemSettingAsync),
                nameof(ContentItemSettingsController.Get),
                nameof(ContentItemSettingsController.GetContentItemSettingByIdAsync),
                nameof(ContentItemSettingsController.PutContentItemSettingAsync),
                nameof(ContentItemSettingsController.DeleteContentItemSettingByIdAsync),
                nameof(ContentItemSettingsController.HardDeleteContentItemSettingByIdAsync)
            };
        ...
        private static List<MethodInfo> GetActions() =>
            typeof(ContentItemSettingsController)
