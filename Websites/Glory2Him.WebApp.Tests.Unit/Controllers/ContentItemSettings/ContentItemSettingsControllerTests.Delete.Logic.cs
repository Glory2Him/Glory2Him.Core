    ...
    public partial class ContentItemSettingsControllerTests
    {
        ...
        public async Task ShouldRemoveRecordOnDeleteByIdsAsync()
        {
            ...
            contentItemSettingServiceMock
                .Setup(service => service.RemoveContentItemSettingByIdAsync(
                    It.IsAny<Guid>(),
                    inputDeletionReason,
            ...
            ActionResult<ContentItemSetting> actualActionResult =
                await contentItemSettingsController.DeleteContentItemSettingByIdAsync(randomContentItemSetting.Id, inputDeletionReason, TestContext.Current.CancellationToken);

            // then
            actualActionResult.ShouldBeEquivalentTo(expectedActionResult);

            contentItemSettingServiceMock
                .Verify(service => service.RemoveContentItemSettingByIdAsync(
                    It.IsAny<Guid>(),
                    inputDeletionReason,
                    It.IsAny<CancellationToken>()),
                        Times.Once);
