    ...
    public partial class ContentItemSettingsControllerTests
    {
        ...
        public async Task ShouldReturnRecordOnGetByIdsAsync()
        {
            ...
            contentItemSettingServiceMock
                .Setup(service => service.RetrieveContentItemSettingByIdAsync(
                    It.IsAny<Guid>(),
            ...
            ActionResult<ContentItemSetting> actualActionResult =
                await contentItemSettingsController.GetContentItemSettingByIdAsync(randomContentItemSetting.Id, TestContext.Current.CancellationToken);

            // then
            actualActionResult.ShouldBeEquivalentTo(expectedActionResult);

            contentItemSettingServiceMock
                .Verify(service => service.RetrieveContentItemSettingByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
