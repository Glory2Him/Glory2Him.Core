    ...
    public partial class TagsControllerTests
    {
            ...
            Xeption serverException)
        {
            ...
            var expectedActionResult =
                new ActionResult<IQueryable<Tag>>(expectedInternalServerErrorObjectResult);
            ...
            ActionResult<IQueryable<Tag>> actualActionResult =
                await this.tagsController.Get(TestContext.Current.CancellationToken);
            ...
            Xeption dependencyException)
        {
            ...
            var expectedActionResult =
                new ActionResult<IQueryable<Tag>>(expectedFailedDependencyObjectResult);
