...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Tags
{
    public partial class TagsControllerTests
    {
        ...
        public async Task ShouldReturnCreatedOnPostAsync()
        {
            ...
            Tag addedTag = inputTag.DeepClone();
            Tag expectedTag = addedTag.DeepClone();

            var expectedObjectResult =
                new CreatedObjectResult(expectedTag);

            var expectedActionResult =
                new ActionResult<Tag>(expectedObjectResult);

            tagServiceMock
                .Setup(service => service.AddTagAsync(inputTag, It.IsAny<CancellationToken>()))
            ...
            tagServiceMock
               .Verify(service => service.AddTagAsync(inputTag, It.IsAny<CancellationToken>()),
                   Times.Once);
