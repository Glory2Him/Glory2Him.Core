...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Tags
{
    public partial class TagsControllerTests
    {
        ...
        public async Task ShouldReturnOkOnSubmitAsync()
        {
            ...
            tagServiceMock
                .Setup(service => service.SubmitTagByIdAsync(
                    It.IsAny<Guid>(),
            ...
            ActionResult<Tag> actualActionResult =
                await tagsController.SubmitTagByIdAsync(randomTag.Id, TestContext.Current.CancellationToken);

            // then
            actualActionResult.ShouldBeEquivalentTo(expectedActionResult);

            tagServiceMock
                .Verify(service => service.SubmitTagByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
