...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Tags
{
    public partial class TagsControllerTests
    {
        ...
        public async Task ShouldRemoveRecordOnDeleteByIdsAsync()
        {
            ...
            tagServiceMock
                .Setup(service => service.RemoveTagByIdAsync(
                    It.IsAny<Guid>(),
                    inputDeletionReason,
            ...
            ActionResult<Tag> actualActionResult =
                await tagsController.DeleteTagByIdAsync(randomTag.Id, inputDeletionReason, TestContext.Current.CancellationToken);

            // then
            actualActionResult.ShouldBeEquivalentTo(expectedActionResult);

            tagServiceMock
                .Verify(service => service.RemoveTagByIdAsync(
                    It.IsAny<Guid>(),
                    inputDeletionReason,
                    It.IsAny<CancellationToken>()),
                        Times.Once);
