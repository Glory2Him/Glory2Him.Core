...
namespace Glory2Him.WebApp.Tests.Unit.Controllers.Tags
{
    public partial class TagsControllerTests
    {
        ...
        public async Task ShouldReturnRecordOnGetByIdsAsync()
        {
            ...
            tagServiceMock
                .Setup(service => service.RetrieveTagByIdAsync(
                    It.IsAny<Guid>(),
            ...
            ActionResult<Tag> actualActionResult =
                await tagsController.GetTagByIdAsync(randomTag.Id, TestContext.Current.CancellationToken);

            // then
            actualActionResult.ShouldBeEquivalentTo(expectedActionResult);

            tagServiceMock
                .Verify(service => service.RetrieveTagByIdAsync(
                    It.IsAny<Guid>(),
                    It.IsAny<CancellationToken>()),
                        Times.Once);
