    ...
    public partial class TagsControllerTests
    {
        ...
        public async Task ShouldReturnBadRequestOnDeleteIfValidationErrorOccurredAsync(Xeption validationException)
        {
            ...
            ActionResult<Tag> actualActionResult =
                await this.tagsController.DeleteTagByIdAsync(someId, null, TestContext.Current.CancellationToken);
            ...
            Xeption dependencyException)
        {
            ...
            this.tagServiceMock.Setup(service =>
                service.RemoveTagByIdAsync(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
