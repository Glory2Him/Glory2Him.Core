...
namespace Glory2Him.WebApp.Tests.Unit.Services.Views.Posts
{
    public partial class PostsViewServiceTests
    {
        ...
        private readonly IPostsViewService postsViewService;

        public PostsViewServiceTests()
        {
            this.loggingBrokerMock = new Mock<ILoggingBroker>();

            this.postsViewService =
                new PostsViewService(loggingBroker: this.loggingBrokerMock.Object);
        }
    }
}
