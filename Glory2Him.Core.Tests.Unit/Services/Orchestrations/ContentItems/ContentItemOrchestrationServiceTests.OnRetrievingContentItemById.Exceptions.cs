...
namespace Glory2Him.Core.Tests.Unit.Services.Orchestrations.ContentItems
{
    public partial class ContentItemOrchestrationServiceTests
    {
        ...
        public async Task ShouldThrowOperationCanceledExceptionOnRetrievingContentItemByIdEventIfCancellationRequestedAsync()
        {
            ...
            // then
            await Assert.ThrowsAsync<OperationCanceledException>(onRetrievingByIdTask.AsTask);
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrievingContentItemByIdEventIfErrorOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrievingContentItemByIdEventIfDependencyErrorOccursAndLogItAsync(
