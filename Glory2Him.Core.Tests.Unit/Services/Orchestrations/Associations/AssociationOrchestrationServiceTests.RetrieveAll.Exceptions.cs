...
namespace Glory2Him.Core.Tests.Unit.Services.Orchestrations.Associations
{
    public partial class AssociationOrchestrationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveAllIfTheFoundationDoesAndLogItAsync(
            Xeption foundationException)
        {
            ...
            // when
            ValueTask<IQueryable<Association>> retrieveAllTask =
                this.associationOrchestrationService.RetrieveAllAssociationsAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllIfTheFoundationDoesAndLogItAsync(
            Xeption foundationException)
        {
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllIfOperationCanceledOccursWithoutRequestAndLogItAsync()
        {
