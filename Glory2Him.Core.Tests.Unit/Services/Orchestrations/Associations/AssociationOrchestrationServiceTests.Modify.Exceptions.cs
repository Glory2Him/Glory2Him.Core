...
namespace Glory2Him.Core.Tests.Unit.Services.Orchestrations.Associations
{
    public partial class AssociationOrchestrationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyIfTheFoundationDoesAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyIfTheFoundationDoesAndLogItAsync(
            Xeption foundationException)
        {
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyIfOperationCanceledOccursWithoutRequestAndLogItAsync()
        {
        ...
        public async Task ShouldThrowOperationCanceledExceptionOnModifyIfCancellationRequestedAsync()
        {
            ...
            // then
            await Assert.ThrowsAsync<OperationCanceledException>(modifyTask.AsTask);
