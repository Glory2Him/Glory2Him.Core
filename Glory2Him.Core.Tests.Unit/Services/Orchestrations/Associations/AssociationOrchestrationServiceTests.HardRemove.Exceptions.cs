...
namespace Glory2Him.Core.Tests.Unit.Services.Orchestrations.Associations
{
    public partial class AssociationOrchestrationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnHardRemoveIfTheFoundationDoesAndLogItAsync(
            Xeption foundationException)
        {
            ...
            // hard removal is Administrators alone, so every path below has to clear
            // that gate before the path it is actually about can be reached
        ...
        public async Task ShouldThrowDependencyExceptionOnHardRemoveIfTheFoundationDoesAndLogItAsync(
            Xeption foundationException)
        {
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnHardRemoveIfServiceErrorOccursAndLogItAsync()
        {
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnHardRemoveIfOperationCanceledOccursWithoutRequestAndLogItAsync()
        {
        ...
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnHardRemoveIfCancellationRequestedAsync()
        {
            ...
            // then
            await Assert.ThrowsAsync<OperationCanceledException>(hardRemoveTask.AsTask);
