...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemSettings
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingContentItemSettingEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingContentItemSettingEventWhenContentItemSettingNotFoundAsync()
        {
            // given
            ...
            var notFoundContentItemSettingException = new NotFoundContentItemSettingException(
                message: $"Content item setting not found with id: {inputContentItemSetting.Id}.");
