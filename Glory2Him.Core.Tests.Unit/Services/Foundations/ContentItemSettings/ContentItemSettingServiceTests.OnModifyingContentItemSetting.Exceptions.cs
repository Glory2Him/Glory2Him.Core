...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemSettings
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnModifyingContentItemSettingEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<ContentItemSetting>?> onModifyingTask =
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyingContentItemSettingEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyingContentItemSettingEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemSetting> requestEnvelope = CreateRandomContentItemSettingRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnModifyingContentItemSettingEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemSetting> requestEnvelope = CreateRandomContentItemSettingRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyingContentItemSettingEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyingContentItemSettingEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemSetting> requestEnvelope = CreateRandomContentItemSettingRequestEnvelope();
