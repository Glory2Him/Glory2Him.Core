...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemSettings
{
    ...
    {
        [Fact]
        public async Task ShouldModifyContentItemSettingAndReplyOnModifyingContentItemSettingEventAsync()
        {
            // given
            ...
            EventEnvelope<ContentItemSetting>? actualReplyEnvelope =
                await this.contentItemSettingService.OnModifyingContentItemSettingAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldSkipModifyAndReplyNullWhenModifyingContentItemSettingEventAlreadyProcessedAsync()
        {
            // given
            var requestEnvelope = new EventEnvelope<ContentItemSetting>
            {
