...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemSettings
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRetrievingContentItemSettingByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<ContentItemSetting>?> onRetrieveTask =
        ...
        [Fact]
        public async Task ShouldPassThroughNotFoundValidationExceptionOnRetrievingContentItemSettingByIdEventAsync()
        {
            // given
            ...
            this.storageBrokerMock.Setup(broker =>
                broker.SelectContentItemSettingByIdAsync(
                    ...
                    TestContext.Current.CancellationToken))
                        .ReturnsAsync((ContentItemSetting?)null);
            ...
            actualContentItemSettingValidationException.InnerException
                .Should().BeOfType<NotFoundContentItemSettingException>();
