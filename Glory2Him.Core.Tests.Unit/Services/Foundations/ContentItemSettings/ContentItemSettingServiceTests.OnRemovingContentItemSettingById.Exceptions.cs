...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemSettings
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnRemovingContentItemSettingByIdEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnRemovingContentItemSettingByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRemovingContentItemSettingByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemSetting> requestEnvelope = CreateRandomContentItemSettingRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnRemovingContentItemSettingByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemSetting> requestEnvelope = CreateRandomContentItemSettingRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRemovingContentItemSettingByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRemovingContentItemSettingByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemSetting> requestEnvelope = CreateRandomContentItemSettingRequestEnvelope();
