...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemSettings
{
    ...
    {
        [Fact]
        public async Task ShouldReplyWithContentItemSettingOnRetrievingContentItemSettingByIdEventAsync()
        {
            // given
            ...
            {
                Content = new ContentItemSetting { Id = randomContentItemSetting.Id }
            };
            ...
            EventEnvelope<ContentItemSetting>? actualReplyEnvelope =
                await this.contentItemSettingService.OnRetrievingContentItemSettingByIdAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
            ...
            this.eventEnvelopeBrokerMock.Verify(broker =>
                broker.CreateNextAsync(requestEnvelope, storageContentItemSetting),
                Times.Once);
