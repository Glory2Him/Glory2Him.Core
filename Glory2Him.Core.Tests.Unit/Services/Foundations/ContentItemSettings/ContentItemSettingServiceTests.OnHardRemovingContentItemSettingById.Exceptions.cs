...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemSettings
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnHardRemovingContentItemSettingByIdEventIfCancellationRequestedAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnHardRemovingContentItemSettingByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemSetting> requestEnvelope = CreateRandomContentItemSettingRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyExceptionOnHardRemovingContentItemSettingByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnHardRemovingContentItemSettingByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemSetting> requestEnvelope = CreateRandomContentItemSettingRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnHardRemovingContentItemSettingByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnHardRemovingContentItemSettingByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemSetting> requestEnvelope = CreateRandomContentItemSettingRequestEnvelope();
