...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Links
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingLinkByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingLinkByIdEventWhenIdIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingLinkByIdEventWhenLinkNotFoundAsync()
        {
            // given
