...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Links
{
    public partial class LinkServiceTests
    {
        ...
        private static Link CreateSubmittableStorageLink()
        {
            Link link = CreateRandomLink();
            link.IsDeleted = false;
            link.ApprovalStatus = ApprovalStatus.Draft;
        ...
        private static Link CreateApprovableStorageLink()
        {
            Link link = CreateSubmittableStorageLink();
            link.ApprovalStatus = ApprovalStatus.Submitted;
        ...
        private static Link CreateApprovalDecision(Guid linkId) =>
            new Link
            {
                Id = linkId,
        ...
        private static Link CreateRejectionDecision(Guid linkId) =>
            new Link
            {
                Id = linkId,
