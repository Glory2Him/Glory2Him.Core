...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Links
{
    public partial class LinkServiceTests
    {
        ...
        public LinkServiceTests()
        {
            ...
            this.eventEnvelopeBrokerMock.Setup(broker =>
                broker.CreateNextAsync(
                    ...
                    It.IsAny<Link>()))
                        .Returns((EventEnvelope<Link> sourceEnvelope, Link content) =>
                            new ValueTask<EventEnvelope<Link>>(
                                new EventEnvelope<Link>
                                {
                                    Content = content,
            ...
            {
                {
                    ...
                    new AlreadyExistsLinkException(
                ...
                },
                {
                    ...
                    new InvalidLinkReferenceException(
            ...
            string userId = "")
        {
            ...
            Link randomLink = CreateLinkFiller(dateTimeOffset, userId).Create();
            randomLink.CreatedWhen = randomLink.CreatedWhen.AddDays(randomDaysInPast);
        ...
        {
            return CreateLinkFiller(dateTimeOffset: GetRandomDateTimeOffset())
        ...
        private static Filler<Link> CreateLinkFiller(
            DateTimeOffset dateTimeOffset,
            string userId = "")
        {
            ...
            filler.Setup()
                ...
                .OnProperty(link => link.CreatedBy).Use(userId)
                .OnProperty(link => link.UpdatedBy).Use(userId)
                ...
                .OnProperty(link => link.PublishDate).IgnoreIt();
