...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Links
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnModifyingLinkEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyingLinkEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyingLinkEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Link> requestEnvelope = CreateRandomLinkRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnModifyingLinkEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Link> requestEnvelope = CreateRandomLinkRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyingLinkEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyingLinkEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Link> requestEnvelope = CreateRandomLinkRequestEnvelope();
