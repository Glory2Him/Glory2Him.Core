...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Links
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnAddingLinkEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnAddingLinkEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnAddingLinkEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Link> requestEnvelope = CreateRandomLinkRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnAddingLinkEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Link> requestEnvelope = CreateRandomLinkRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnAddingLinkEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAddingLinkEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Link> requestEnvelope = CreateRandomLinkRequestEnvelope();
