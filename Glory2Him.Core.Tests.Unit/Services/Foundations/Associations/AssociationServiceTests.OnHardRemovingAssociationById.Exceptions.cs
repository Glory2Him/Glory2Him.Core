...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Associations
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnHardRemovingAssociationByIdEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<Association>?> onHardRemovingTask =
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnHardRemovingAssociationByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Association> requestEnvelope = CreateRandomAssociationRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyExceptionOnHardRemovingAssociationByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnHardRemovingAssociationByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Association> requestEnvelope = CreateRandomAssociationRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnHardRemovingAssociationByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnHardRemovingAssociationByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Association> requestEnvelope = CreateRandomAssociationRequestEnvelope();
