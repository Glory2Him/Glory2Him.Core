...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Associations
{
    ...
    {
        [Fact]
        public async Task ShouldReplyWithAssociationOnRetrievingAssociationByIdEventAsync()
        {
            // given
            ...
            var requestEnvelope = new EventEnvelope<Association>
            {
                ...
                Content = new Association { Id = randomAssociation.Id }
            };
            ...
            EventEnvelope<Association>? actualReplyEnvelope =
                await this.associationService.OnRetrievingAssociationByIdAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
