...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Associations
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingAssociationEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingAssociationEventWhenAssociationNotFoundAsync()
        {
            // given
            ...
            var notFoundAssociationException = new NotFoundAssociationException(
                message: $"Content item association not found with id: {inputAssociation.Id}.");
