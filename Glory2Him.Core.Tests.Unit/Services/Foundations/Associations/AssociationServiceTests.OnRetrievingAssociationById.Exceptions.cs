...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Associations
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnRetrievingAssociationByIdEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<Association>?> onRetrievingTask =
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrievingAssociationByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Association> requestEnvelope = CreateRandomAssociationRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldPassThroughDependencyExceptionOnRetrievingAssociationByIdEventAsync()
        {
            // given
            EventEnvelope<Association> requestEnvelope = CreateRandomAssociationRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrievingAssociationByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            ...
            this.eventEnvelopeBrokerMock.Setup(broker =>
                broker.CreateNextAsync(requestEnvelope, storageAssociation))
