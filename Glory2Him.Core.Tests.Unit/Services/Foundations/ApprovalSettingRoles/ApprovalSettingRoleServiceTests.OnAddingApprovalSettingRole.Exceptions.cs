...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnAddingApprovalSettingRoleEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnAddingApprovalSettingRoleEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnAddingApprovalSettingRoleEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingRole> requestEnvelope = CreateRandomApprovalSettingRoleRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnAddingApprovalSettingRoleEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingRole> requestEnvelope = CreateRandomApprovalSettingRoleRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnAddingApprovalSettingRoleEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAddingApprovalSettingRoleEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingRole> requestEnvelope = CreateRandomApprovalSettingRoleRequestEnvelope();
