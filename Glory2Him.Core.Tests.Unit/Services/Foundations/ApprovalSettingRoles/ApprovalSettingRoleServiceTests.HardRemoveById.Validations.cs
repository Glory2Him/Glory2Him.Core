...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingRoles
{
    public partial class ApprovalSettingRoleServiceTests
    {
        ...
        public async Task ShouldThrowValidationExceptionOnHardRemoveByIdIfIdIsInvalidAndLogItAsync()
        {
            ...
            // when
            ValueTask<ApprovalSettingRole> hardRemoveApprovalSettingRoleByIdTask =
                this.approvalSettingRoleService.HardRemoveApprovalSettingRoleByIdAsync(
            ...
            ApprovalSettingRoleValidationException actualApprovalSettingRoleValidationException =
                await Assert.ThrowsAsync<ApprovalSettingRoleValidationException>(
                    hardRemoveApprovalSettingRoleByIdTask.AsTask);
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnHardRemoveByIdIfApprovalSettingRoleNotFoundAndLogItAsync()
        {
            // given
