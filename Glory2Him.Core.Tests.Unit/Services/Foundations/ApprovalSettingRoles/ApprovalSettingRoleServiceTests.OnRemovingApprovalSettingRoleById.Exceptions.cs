...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnRemovingApprovalSettingRoleByIdEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<ApprovalSettingRole>?> onRemovingTask =
        ...
        public async Task ShouldThrowDependencyExceptionOnRemovingApprovalSettingRoleByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRemovingApprovalSettingRoleByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingRole> requestEnvelope = CreateRandomApprovalSettingRoleRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnRemovingApprovalSettingRoleByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingRole> requestEnvelope = CreateRandomApprovalSettingRoleRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRemovingApprovalSettingRoleByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRemovingApprovalSettingRoleByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingRole> requestEnvelope = CreateRandomApprovalSettingRoleRequestEnvelope();
