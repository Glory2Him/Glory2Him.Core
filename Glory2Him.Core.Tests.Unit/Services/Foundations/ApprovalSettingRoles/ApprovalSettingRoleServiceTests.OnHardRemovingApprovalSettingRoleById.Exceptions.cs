...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnHardRemovingApprovalSettingRoleByIdEventIfCancellationRequestedAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnHardRemovingApprovalSettingRoleByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingRole> requestEnvelope = CreateRandomApprovalSettingRoleRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyExceptionOnHardRemovingApprovalSettingRoleByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnHardRemovingApprovalSettingRoleByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingRole> requestEnvelope = CreateRandomApprovalSettingRoleRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnHardRemovingApprovalSettingRoleByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnHardRemovingApprovalSettingRoleByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingRole> requestEnvelope = CreateRandomApprovalSettingRoleRequestEnvelope();
