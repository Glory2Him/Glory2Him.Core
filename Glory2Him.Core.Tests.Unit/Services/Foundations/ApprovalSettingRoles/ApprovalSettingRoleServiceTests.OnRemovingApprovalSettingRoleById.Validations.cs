...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalSettingRoleByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalSettingRoleByIdEventWhenIdIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalSettingRoleByIdEventWhenApprovalSettingRoleNotFoundAsync()
        {
            // given
