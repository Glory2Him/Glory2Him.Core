...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentTypes
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRetrievingContentTypeByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<ContentType>?> onRetrieveTask =
        ...
        [Fact]
        public async Task ShouldPassThroughNotFoundValidationExceptionOnRetrievingContentTypeByIdEventAsync()
        {
            // given
            ...
            actualContentTypeValidationException.InnerException
                .Should().BeOfType<NotFoundContentTypeException>();
