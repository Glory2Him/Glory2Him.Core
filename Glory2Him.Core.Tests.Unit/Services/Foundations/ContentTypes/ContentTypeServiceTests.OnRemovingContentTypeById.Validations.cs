...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentTypes
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingContentTypeByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingContentTypeByIdEventWhenIdIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingContentTypeByIdEventWhenContentTypeNotFoundAsync()
        {
            // given
