...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentTypes
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnHardRemovingContentTypeByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnHardRemovingContentTypeByIdEventWhenIdIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnHardRemovingContentTypeByIdEventWhenContentTypeNotFoundAsync()
        {
            // given
