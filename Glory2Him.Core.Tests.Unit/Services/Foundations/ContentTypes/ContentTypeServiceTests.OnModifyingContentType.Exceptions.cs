...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentTypes
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnModifyingContentTypeEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyingContentTypeEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyingContentTypeEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentType> requestEnvelope = CreateRandomContentTypeRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnModifyingContentTypeEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentType> requestEnvelope = CreateRandomContentTypeRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyingContentTypeEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyingContentTypeEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentType> requestEnvelope = CreateRandomContentTypeRequestEnvelope();
