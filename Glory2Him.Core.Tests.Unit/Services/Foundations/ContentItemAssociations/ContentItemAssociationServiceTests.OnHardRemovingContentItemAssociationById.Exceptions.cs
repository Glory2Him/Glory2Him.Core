...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemAssociations
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnHardRemovingContentItemAssociationByIdEventIfCancellationRequestedAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnHardRemovingContentItemAssociationByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemAssociation> requestEnvelope = CreateRandomContentItemAssociationRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyExceptionOnHardRemovingContentItemAssociationByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnHardRemovingContentItemAssociationByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemAssociation> requestEnvelope = CreateRandomContentItemAssociationRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnHardRemovingContentItemAssociationByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnHardRemovingContentItemAssociationByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemAssociation> requestEnvelope = CreateRandomContentItemAssociationRequestEnvelope();
