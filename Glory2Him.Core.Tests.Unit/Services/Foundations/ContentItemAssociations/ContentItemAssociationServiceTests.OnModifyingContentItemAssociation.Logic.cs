...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemAssociations
{
    ...
    {
        [Fact]
        public async Task ShouldModifyContentItemAssociationAndReplyOnModifyingContentItemAssociationEventAsync()
        {
            // given
            ...
            EventEnvelope<ContentItemAssociation>? actualReplyEnvelope =
                await this.contentItemAssociationService.OnModifyingContentItemAssociationAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldSkipModifyAndReplyNullWhenModifyingContentItemAssociationEventAlreadyProcessedAsync()
        {
            // given
            var requestEnvelope = new EventEnvelope<ContentItemAssociation>
            {
