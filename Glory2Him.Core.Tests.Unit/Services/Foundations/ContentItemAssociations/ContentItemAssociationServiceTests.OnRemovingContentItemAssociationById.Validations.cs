...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemAssociations
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingContentItemAssociationByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingContentItemAssociationByIdEventWhenIdIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingContentItemAssociationByIdEventWhenContentItemAssociationNotFoundAsync()
        {
            // given
