...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemAssociations
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnAddingContentItemAssociationEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnAddingContentItemAssociationEventWhenMetadataIsNullAsync()
        {
            // given
            var invalidEnvelope = new EventEnvelope<ContentItemAssociation>
            {
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnAddingContentItemAssociationEventWhenContentIsNullAsync()
        {
            // given
            var invalidEnvelope = new EventEnvelope<ContentItemAssociation>
            {
