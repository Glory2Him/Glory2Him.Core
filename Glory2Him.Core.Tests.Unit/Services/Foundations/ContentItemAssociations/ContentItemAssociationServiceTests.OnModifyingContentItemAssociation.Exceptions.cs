...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemAssociations
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnModifyingContentItemAssociationEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<ContentItemAssociation>?> onModifyingTask =
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyingContentItemAssociationEventIfErrorOccursAndLogItAsync(
            ...
            Xeption expectedInnerException)
        {
            ...
            this.storageBrokerMock.Setup(broker =>
                broker.SelectProcessedEventExistsAsync(
                    ...
                    EventBrokerIdentifiers.ContentItemAssociationOnModifyingContentItemAssociationSubscriptionName,
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyingContentItemAssociationEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemAssociation> requestEnvelope = CreateRandomContentItemAssociationRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnModifyingContentItemAssociationEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemAssociation> requestEnvelope = CreateRandomContentItemAssociationRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyingContentItemAssociationEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyingContentItemAssociationEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemAssociation> requestEnvelope = CreateRandomContentItemAssociationRequestEnvelope();
