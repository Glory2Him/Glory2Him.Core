...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemAssociations
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnAddingContentItemAssociationEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<ContentItemAssociation>?> onAddingTask =
        ...
        public async Task ShouldThrowDependencyExceptionOnAddingContentItemAssociationEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnAddingContentItemAssociationEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemAssociation> requestEnvelope = CreateRandomContentItemAssociationRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnAddingContentItemAssociationEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemAssociation> requestEnvelope = CreateRandomContentItemAssociationRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnAddingContentItemAssociationEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAddingContentItemAssociationEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItemAssociation> requestEnvelope = CreateRandomContentItemAssociationRequestEnvelope();
