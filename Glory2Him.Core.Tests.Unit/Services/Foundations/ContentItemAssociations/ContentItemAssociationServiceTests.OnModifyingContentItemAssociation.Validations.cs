...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItemAssociations
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingContentItemAssociationEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingContentItemAssociationEventWhenContentItemAssociationNotFoundAsync()
        {
            // given
            ...
            var notFoundContentItemAssociationException = new NotFoundContentItemAssociationException(
                message: $"Content item association not found with id: {inputContentItemAssociation.Id}.");
