...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Approvals
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalByIdEventWhenIdIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalByIdEventWhenApprovalNotFoundAsync()
        {
            // given
