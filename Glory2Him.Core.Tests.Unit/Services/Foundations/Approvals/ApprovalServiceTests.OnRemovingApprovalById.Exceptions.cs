...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Approvals
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnRemovingApprovalByIdEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<Approval>?> onRemovingTask =
                this.approvalService.OnRemovingApprovalByIdAsync(
                    requestEnvelope,
                    cancellationToken);
        ...
        public async Task ShouldThrowDependencyExceptionOnRemovingApprovalByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRemovingApprovalByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Approval> requestEnvelope = CreateRandomApprovalRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnRemovingApprovalByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Approval> requestEnvelope = CreateRandomApprovalRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRemovingApprovalByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRemovingApprovalByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Approval> requestEnvelope = CreateRandomApprovalRequestEnvelope();
