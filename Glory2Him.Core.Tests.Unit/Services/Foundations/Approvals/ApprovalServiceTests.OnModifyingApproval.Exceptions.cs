...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Approvals
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnModifyingApprovalEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<Approval>?> onModifyingTask =
                this.approvalService.OnModifyingApprovalAsync(
                    requestEnvelope,
                    cancellationToken);
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyingApprovalEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyingApprovalEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Approval> requestEnvelope = CreateRandomApprovalRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnModifyingApprovalEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Approval> requestEnvelope = CreateRandomApprovalRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyingApprovalEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyingApprovalEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Approval> requestEnvelope = CreateRandomApprovalRequestEnvelope();
