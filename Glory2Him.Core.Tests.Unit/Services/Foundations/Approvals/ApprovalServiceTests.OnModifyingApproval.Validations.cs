...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Approvals
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingApprovalEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingApprovalEventWhenApprovalNotFoundAsync()
        {
            // given
            string randomUserId = GetRandomString();
            DateTimeOffset randomDateTimeOffset = GetRandomDateTimeOffset();
            Approval inputApproval = CreateRandomModifyApproval(randomDateTimeOffset, randomUserId);
            ...
            var notFoundApprovalException = new NotFoundApprovalException(
                message: $"Approval not found with id: {inputApproval.Id}.");
