...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalComments
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnAddingApprovalCommentEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnAddingApprovalCommentEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnAddingApprovalCommentEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalComment> requestEnvelope = CreateRandomApprovalCommentRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnAddingApprovalCommentEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalComment> requestEnvelope = CreateRandomApprovalCommentRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnAddingApprovalCommentEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAddingApprovalCommentEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalComment> requestEnvelope = CreateRandomApprovalCommentRequestEnvelope();
