...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalComments
{
    ...
    {
        [Fact]
        public async Task ShouldAddApprovalCommentAndReplyOnAddingApprovalCommentEventAsync()
        {
            // given
            ...
            EventEnvelope<ApprovalComment>? actualReplyEnvelope =
                await this.approvalCommentService.OnAddingApprovalCommentAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldSkipAddAndReplyNullWhenAddingApprovalCommentEventAlreadyProcessedAsync()
        {
            // given
            var requestEnvelope = new EventEnvelope<ApprovalComment>
            {
