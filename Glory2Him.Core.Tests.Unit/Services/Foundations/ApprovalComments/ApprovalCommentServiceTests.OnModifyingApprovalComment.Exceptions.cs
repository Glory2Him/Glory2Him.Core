...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalComments
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnModifyingApprovalCommentEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyingApprovalCommentEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyingApprovalCommentEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalComment> requestEnvelope = CreateRandomApprovalCommentRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnModifyingApprovalCommentEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalComment> requestEnvelope = CreateRandomApprovalCommentRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyingApprovalCommentEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyingApprovalCommentEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalComment> requestEnvelope = CreateRandomApprovalCommentRequestEnvelope();
