...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalComments
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnHardRemovingApprovalCommentByIdEventIfCancellationRequestedAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnHardRemovingApprovalCommentByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalComment> requestEnvelope = CreateRandomApprovalCommentRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyExceptionOnHardRemovingApprovalCommentByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnHardRemovingApprovalCommentByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalComment> requestEnvelope = CreateRandomApprovalCommentRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnHardRemovingApprovalCommentByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnHardRemovingApprovalCommentByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalComment> requestEnvelope = CreateRandomApprovalCommentRequestEnvelope();
