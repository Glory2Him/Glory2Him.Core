...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalComments
{
    ...
    {
        [Fact]
        public async Task ShouldModifyApprovalCommentAndReplyOnModifyingApprovalCommentEventAsync()
        {
            // given
            ...
            EventEnvelope<ApprovalComment>? actualReplyEnvelope =
                await this.approvalCommentService.OnModifyingApprovalCommentAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldSkipModifyAndReplyNullWhenModifyingApprovalCommentEventAlreadyProcessedAsync()
        {
            // given
            var requestEnvelope = new EventEnvelope<ApprovalComment>
            {
