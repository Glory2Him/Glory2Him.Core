...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.BibleReferences
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnHardRemovingBibleReferenceByIdEventIfCancellationRequestedAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnHardRemovingBibleReferenceByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<BibleReference> requestEnvelope = CreateRandomBibleReferenceRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyExceptionOnHardRemovingBibleReferenceByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnHardRemovingBibleReferenceByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<BibleReference> requestEnvelope = CreateRandomBibleReferenceRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnHardRemovingBibleReferenceByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnHardRemovingBibleReferenceByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<BibleReference> requestEnvelope = CreateRandomBibleReferenceRequestEnvelope();
