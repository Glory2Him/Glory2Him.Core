...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.BibleReferences
{
    ...
    {
        [Fact]
        public async Task ShouldModifyBibleReferenceAndReplyOnModifyingBibleReferenceEventAsync()
        {
            // given
            ...
            EventEnvelope<BibleReference>? actualReplyEnvelope =
                await this.bibleReferenceService.OnModifyingBibleReferenceAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldSkipModifyAndReplyNullWhenModifyingBibleReferenceEventAlreadyProcessedAsync()
        {
            // given
            var requestEnvelope = new EventEnvelope<BibleReference>
            {
