...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.BibleReferences
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingBibleReferenceEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingBibleReferenceEventWhenBibleReferenceNotFoundAsync()
        {
            // given
            string randomUserId = GetRandomString();
            DateTimeOffset randomDateTimeOffset = GetRandomDateTimeOffset();
            BibleReference inputBibleReference = CreateRandomModifyBibleReference(randomDateTimeOffset, randomUserId);
            ...
            var notFoundBibleReferenceException = new NotFoundBibleReferenceException(
                message: $"Bible reference not found with id: {inputBibleReference.Id}.");
