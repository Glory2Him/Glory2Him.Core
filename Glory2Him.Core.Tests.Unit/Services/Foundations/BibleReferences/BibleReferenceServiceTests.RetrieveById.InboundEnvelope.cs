...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.BibleReferences
{
    public partial class BibleReferenceServiceTests
    {
        ...
        [Fact]
        public async Task ShouldRetrieveNonPublicBibleReferenceByIdAsTheInboundEnvelopesCallerAsync()
        {
            // given
            ...
            this.eventEnvelopeBrokerMock.Verify(broker =>
                broker.CreateNextAsync(
                    inboundEnvelope,
                    It.Is<BibleReference>(bibleReference => bibleReference.Id == randomBibleReference.Id)),
                Times.Once);
