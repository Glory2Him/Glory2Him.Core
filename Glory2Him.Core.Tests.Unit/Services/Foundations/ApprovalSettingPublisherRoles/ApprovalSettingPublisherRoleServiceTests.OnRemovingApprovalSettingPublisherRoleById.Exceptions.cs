...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingPublisherRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnRemovingApprovalSettingPublisherRoleByIdEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<ApprovalSettingPublisherRole>?> onRemovingTask =
        ...
        public async Task ShouldThrowDependencyExceptionOnRemovingApprovalSettingPublisherRoleByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRemovingApprovalSettingPublisherRoleByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingPublisherRole> requestEnvelope = CreateRandomApprovalSettingPublisherRoleRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnRemovingApprovalSettingPublisherRoleByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingPublisherRole> requestEnvelope = CreateRandomApprovalSettingPublisherRoleRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRemovingApprovalSettingPublisherRoleByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRemovingApprovalSettingPublisherRoleByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingPublisherRole> requestEnvelope = CreateRandomApprovalSettingPublisherRoleRequestEnvelope();
