...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingPublisherRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnAddingApprovalSettingPublisherRoleEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnAddingApprovalSettingPublisherRoleEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnAddingApprovalSettingPublisherRoleEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingPublisherRole> requestEnvelope = CreateRandomApprovalSettingPublisherRoleRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnAddingApprovalSettingPublisherRoleEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingPublisherRole> requestEnvelope = CreateRandomApprovalSettingPublisherRoleRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnAddingApprovalSettingPublisherRoleEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAddingApprovalSettingPublisherRoleEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingPublisherRole> requestEnvelope = CreateRandomApprovalSettingPublisherRoleRequestEnvelope();
