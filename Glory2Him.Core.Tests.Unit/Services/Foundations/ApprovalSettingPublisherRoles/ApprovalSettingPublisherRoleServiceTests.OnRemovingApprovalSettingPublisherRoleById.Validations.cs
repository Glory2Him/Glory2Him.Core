...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingPublisherRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalSettingPublisherRoleByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalSettingPublisherRoleByIdEventWhenIdIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalSettingPublisherRoleByIdEventWhenApprovalSettingPublisherRoleNotFoundAsync()
        {
            // given
