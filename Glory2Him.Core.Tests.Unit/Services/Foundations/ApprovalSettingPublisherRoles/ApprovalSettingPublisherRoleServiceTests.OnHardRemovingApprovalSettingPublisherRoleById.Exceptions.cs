...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingPublisherRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnHardRemovingApprovalSettingPublisherRoleByIdEventIfCancellationRequestedAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnHardRemovingApprovalSettingPublisherRoleByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingPublisherRole> requestEnvelope = CreateRandomApprovalSettingPublisherRoleRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyExceptionOnHardRemovingApprovalSettingPublisherRoleByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnHardRemovingApprovalSettingPublisherRoleByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingPublisherRole> requestEnvelope = CreateRandomApprovalSettingPublisherRoleRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnHardRemovingApprovalSettingPublisherRoleByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnHardRemovingApprovalSettingPublisherRoleByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingPublisherRole> requestEnvelope = CreateRandomApprovalSettingPublisherRoleRequestEnvelope();
