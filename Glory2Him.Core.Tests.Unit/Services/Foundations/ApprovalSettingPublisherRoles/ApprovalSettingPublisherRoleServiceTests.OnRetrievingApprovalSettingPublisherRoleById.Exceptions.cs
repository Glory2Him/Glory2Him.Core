...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingPublisherRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnRetrievingApprovalSettingPublisherRoleByIdEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<ApprovalSettingPublisherRole>?> onRetrievingTask =
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrievingApprovalSettingPublisherRoleByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingPublisherRole> requestEnvelope = CreateRandomApprovalSettingPublisherRoleRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldPassThroughDependencyExceptionOnRetrievingApprovalSettingPublisherRoleByIdEventAsync()
        {
            // given
            EventEnvelope<ApprovalSettingPublisherRole> requestEnvelope = CreateRandomApprovalSettingPublisherRoleRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrievingApprovalSettingPublisherRoleByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
