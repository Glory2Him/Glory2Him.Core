...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingPublisherRoles
{
    ...
    {
        [Fact]
        public async Task ShouldAddApprovalSettingPublisherRoleAndReplyOnAddingApprovalSettingPublisherRoleEventAsync()
        {
            // given
            ...
            EventEnvelope<ApprovalSettingPublisherRole>? actualReplyEnvelope =
                await this.approvalSettingPublisherRoleService.OnAddingApprovalSettingPublisherRoleAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldSkipAddAndReplyNullWhenAddingApprovalSettingPublisherRoleEventAlreadyProcessedAsync()
        {
            // given
            var requestEnvelope = new EventEnvelope<ApprovalSettingPublisherRole>
            {
