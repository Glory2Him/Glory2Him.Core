...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Reactions
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnHardRemovingReactionByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnHardRemovingReactionByIdEventWhenIdIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnHardRemovingReactionByIdEventWhenReactionNotFoundAsync()
        {
            // given
