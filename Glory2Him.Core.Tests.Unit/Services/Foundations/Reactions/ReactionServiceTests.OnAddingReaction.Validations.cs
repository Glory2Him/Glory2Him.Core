...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Reactions
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnAddingReactionEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnAddingReactionEventWhenMetadataIsNullAsync()
        {
            // given
            var invalidEnvelope = new EventEnvelope<Reaction>
            {
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnAddingReactionEventWhenContentIsNullAsync()
        {
            // given
            var invalidEnvelope = new EventEnvelope<Reaction>
            {
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnAddingReactionEventWhenIntegrityVerificationFailsAsync()
        {
            // given
            var forgedEnvelope = new EventEnvelope<Reaction>
            {
                SecurityContext = CreateAuthenticatedSecurityContext(),
                Content = new Reaction { Id = Guid.NewGuid() },
                Metadata = new EventMetadata { EventId = Guid.NewGuid() }
            ...
            string expectedEventName =
                $"{nameof(Reaction)}{ReactionEventOperation.Adding}";
