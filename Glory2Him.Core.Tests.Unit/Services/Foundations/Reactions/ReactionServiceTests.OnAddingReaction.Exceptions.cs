...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Reactions
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnAddingReactionEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<Reaction>?> onAddingTask =
                this.reactionService.OnAddingReactionAsync(
                    requestEnvelope,
                    cancellationToken);
        ...
        public async Task ShouldThrowDependencyExceptionOnAddingReactionEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnAddingReactionEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Reaction> requestEnvelope = CreateRandomReactionRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnAddingReactionEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Reaction> requestEnvelope = CreateRandomReactionRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnAddingReactionEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAddingReactionEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Reaction> requestEnvelope = CreateRandomReactionRequestEnvelope();
