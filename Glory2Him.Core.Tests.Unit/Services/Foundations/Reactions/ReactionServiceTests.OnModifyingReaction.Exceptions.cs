...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Reactions
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnModifyingReactionEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<Reaction>?> onModifyingTask =
                this.reactionService.OnModifyingReactionAsync(
                    requestEnvelope,
                    cancellationToken);
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyingReactionEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyingReactionEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Reaction> requestEnvelope = CreateRandomReactionRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnModifyingReactionEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Reaction> requestEnvelope = CreateRandomReactionRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyingReactionEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyingReactionEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Reaction> requestEnvelope = CreateRandomReactionRequestEnvelope();
