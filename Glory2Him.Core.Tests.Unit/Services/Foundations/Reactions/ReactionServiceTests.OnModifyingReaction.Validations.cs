...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Reactions
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingReactionEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyingReactionEventWhenReactionNotFoundAsync()
        {
            // given
            string randomUserId = GetRandomString();
            DateTimeOffset randomDateTimeOffset = GetRandomDateTimeOffset();
            Reaction inputReaction = CreateRandomModifyReaction(randomDateTimeOffset, randomUserId);
            ...
            var notFoundReactionException = new NotFoundReactionException(
                message: $"Reaction not found with id: {inputReaction.Id}.");
