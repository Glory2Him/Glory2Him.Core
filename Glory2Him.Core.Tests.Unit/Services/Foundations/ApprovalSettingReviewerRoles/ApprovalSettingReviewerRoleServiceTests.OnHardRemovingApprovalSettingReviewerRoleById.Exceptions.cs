...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingReviewerRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnHardRemovingApprovalSettingReviewerRoleByIdEventIfCancellationRequestedAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnHardRemovingApprovalSettingReviewerRoleByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingReviewerRole> requestEnvelope = CreateRandomApprovalSettingReviewerRoleRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyExceptionOnHardRemovingApprovalSettingReviewerRoleByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnHardRemovingApprovalSettingReviewerRoleByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingReviewerRole> requestEnvelope = CreateRandomApprovalSettingReviewerRoleRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnHardRemovingApprovalSettingReviewerRoleByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnHardRemovingApprovalSettingReviewerRoleByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingReviewerRole> requestEnvelope = CreateRandomApprovalSettingReviewerRoleRequestEnvelope();
