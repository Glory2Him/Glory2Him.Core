...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingReviewerRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalSettingReviewerRoleByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalSettingReviewerRoleByIdEventWhenIdIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalSettingReviewerRoleByIdEventWhenApprovalSettingReviewerRoleNotFoundAsync()
        {
            // given
