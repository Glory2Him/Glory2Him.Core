...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingReviewerRoles
{
    ...
    {
        [Fact]
        public async Task ShouldHardRemoveApprovalSettingReviewerRoleByIdAndReplyOnHardRemovingApprovalSettingReviewerRoleByIdEventAsync()
        {
            // given
            ApprovalSettingReviewerRole storageApprovalSettingReviewerRole = CreateRandomApprovalSettingReviewerRole();
            ApprovalSettingReviewerRole deletedApprovalSettingReviewerRole = storageApprovalSettingReviewerRole.DeepClone();
            ApprovalSettingReviewerRole expectedApprovalSettingReviewerRole = deletedApprovalSettingReviewerRole.DeepClone();
            ...
            this.storageBrokerMock.Setup(broker =>
                broker.DeleteApprovalSettingReviewerRoleAsync(storageApprovalSettingReviewerRole, It.IsAny<CancellationToken>()))
                    .ReturnsAsync(deletedApprovalSettingReviewerRole);
            ...
            EventEnvelope<ApprovalSettingReviewerRole>? actualReplyEnvelope =
                await this.approvalSettingReviewerRoleService.OnHardRemovingApprovalSettingReviewerRoleByIdAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldSkipHardRemoveAndReplyNullWhenHardRemovingApprovalSettingReviewerRoleByIdEventAlreadyProcessedAsync()
        {
            // given
            var requestEnvelope = new EventEnvelope<ApprovalSettingReviewerRole>
            {
