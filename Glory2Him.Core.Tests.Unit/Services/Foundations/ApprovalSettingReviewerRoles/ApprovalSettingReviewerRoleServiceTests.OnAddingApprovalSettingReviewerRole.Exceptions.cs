...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingReviewerRoles
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnAddingApprovalSettingReviewerRoleEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnAddingApprovalSettingReviewerRoleEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnAddingApprovalSettingReviewerRoleEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingReviewerRole> requestEnvelope = CreateRandomApprovalSettingReviewerRoleRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnAddingApprovalSettingReviewerRoleEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingReviewerRole> requestEnvelope = CreateRandomApprovalSettingReviewerRoleRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnAddingApprovalSettingReviewerRoleEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAddingApprovalSettingReviewerRoleEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSettingReviewerRole> requestEnvelope = CreateRandomApprovalSettingReviewerRoleRequestEnvelope();
