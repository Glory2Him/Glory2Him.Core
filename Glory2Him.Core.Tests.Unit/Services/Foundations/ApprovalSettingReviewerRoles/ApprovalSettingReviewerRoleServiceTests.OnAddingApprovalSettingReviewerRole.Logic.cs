...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettingReviewerRoles
{
    ...
    {
        [Fact]
        public async Task ShouldAddApprovalSettingReviewerRoleAndReplyOnAddingApprovalSettingReviewerRoleEventAsync()
        {
            // given
            ...
            EventEnvelope<ApprovalSettingReviewerRole>? actualReplyEnvelope =
                await this.approvalSettingReviewerRoleService.OnAddingApprovalSettingReviewerRoleAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldSkipAddAndReplyNullWhenAddingApprovalSettingReviewerRoleEventAlreadyProcessedAsync()
        {
            // given
            var requestEnvelope = new EventEnvelope<ApprovalSettingReviewerRole>
            {
