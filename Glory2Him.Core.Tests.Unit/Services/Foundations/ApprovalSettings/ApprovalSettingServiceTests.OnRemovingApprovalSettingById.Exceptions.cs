...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettings
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnRemovingApprovalSettingByIdEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<ApprovalSetting>?> onRemovingTask =
                this.approvalSettingService.OnRemovingApprovalSettingByIdAsync(
                    requestEnvelope,
                    cancellationToken);
        ...
        public async Task ShouldThrowDependencyExceptionOnRemovingApprovalSettingByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRemovingApprovalSettingByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSetting> requestEnvelope = CreateRandomApprovalSettingRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnRemovingApprovalSettingByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSetting> requestEnvelope = CreateRandomApprovalSettingRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRemovingApprovalSettingByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRemovingApprovalSettingByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSetting> requestEnvelope = CreateRandomApprovalSettingRequestEnvelope();
