...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalSettings
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnModifyingApprovalSettingEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyingApprovalSettingEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyingApprovalSettingEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSetting> requestEnvelope = CreateRandomApprovalSettingRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnModifyingApprovalSettingEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSetting> requestEnvelope = CreateRandomApprovalSettingRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyingApprovalSettingEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyingApprovalSettingEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalSetting> requestEnvelope = CreateRandomApprovalSettingRequestEnvelope();
