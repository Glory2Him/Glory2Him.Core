...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Tags
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnAddingTagEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnAddingTagEventWhenMetadataIsNullAsync()
        {
            // given
            var invalidEnvelope = new EventEnvelope<Tag>
            {
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnAddingTagEventWhenContentIsNullAsync()
        {
            // given
            var invalidEnvelope = new EventEnvelope<Tag>
            {
