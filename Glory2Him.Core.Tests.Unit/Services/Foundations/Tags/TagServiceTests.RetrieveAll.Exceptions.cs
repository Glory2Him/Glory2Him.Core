...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Tags
{
    public partial class TagServiceTests
    {
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            ...
            // when
            ValueTask<IQueryable<Tag>> retrieveAllTagsTask =
                this.tagService.RetrieveAllTagsAsync(
                    TestContext.Current.CancellationToken);

            TagDependencyException actualTagDependencyException =
                await Assert.ThrowsAsync<TagDependencyException>(
                    retrieveAllTagsTask.AsTask);
        ...
        public async Task ShouldThrowOperationCanceledExceptionOnRetrieveAllIfCancellationRequestedAsync()
        {
            ...
            // when
            ValueTask<IQueryable<Tag>> retrieveAllTagsTask =
                this.tagService.RetrieveAllTagsAsync(cancellationToken);
