...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Tags
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingTagByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingTagByIdEventWhenIdIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingTagByIdEventWhenTagNotFoundAsync()
        {
            // given
