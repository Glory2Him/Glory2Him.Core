...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Tags
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnRemovingTagByIdEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<Tag>?> onRemovingTask =
                this.tagService.OnRemovingTagByIdAsync(
                    requestEnvelope,
                    cancellationToken);
        ...
        public async Task ShouldThrowDependencyExceptionOnRemovingTagByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRemovingTagByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Tag> requestEnvelope = CreateRandomTagRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnRemovingTagByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Tag> requestEnvelope = CreateRandomTagRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRemovingTagByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRemovingTagByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Tag> requestEnvelope = CreateRandomTagRequestEnvelope();
