...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Tags
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnHardRemovingTagByIdEventIfCancellationRequestedAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnHardRemovingTagByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Tag> requestEnvelope = CreateRandomTagRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyExceptionOnHardRemovingTagByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnHardRemovingTagByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Tag> requestEnvelope = CreateRandomTagRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnHardRemovingTagByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnHardRemovingTagByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Tag> requestEnvelope = CreateRandomTagRequestEnvelope();
