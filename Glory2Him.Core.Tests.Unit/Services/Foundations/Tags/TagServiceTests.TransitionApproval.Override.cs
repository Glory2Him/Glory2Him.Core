...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Tags
{
    ...
    public partial class TagServiceTests
    {
        ...
        public async Task ShouldRefuseASystemIdentityClaimedOnAnInboundEnvelopeAsync()
        {
            ...
            // Tag-Approving address would otherwise declare themselves the workflow and walk past
            ...
            // when
            ValueTask<EventEnvelope<Tag>?> transitionTask =
            ...
            actualException.InnerException.Should()
                .BeEquivalentTo(unauthorizedTagException);
