...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Tags
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnModifyingTagEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyingTagEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyingTagEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Tag> requestEnvelope = CreateRandomTagRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnModifyingTagEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Tag> requestEnvelope = CreateRandomTagRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyingTagEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyingTagEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Tag> requestEnvelope = CreateRandomTagRequestEnvelope();
