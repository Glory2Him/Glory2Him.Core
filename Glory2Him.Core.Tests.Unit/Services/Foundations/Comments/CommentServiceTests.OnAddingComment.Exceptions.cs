...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Comments
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnAddingCommentEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnAddingCommentEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnAddingCommentEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Comment> requestEnvelope = CreateRandomCommentRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnAddingCommentEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Comment> requestEnvelope = CreateRandomCommentRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnAddingCommentEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAddingCommentEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Comment> requestEnvelope = CreateRandomCommentRequestEnvelope();
