...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Comments
{
    ...
    public partial class CommentServiceTests
    {
            ...
            ApprovalStatus terminalStatus)
        {
            ...
            Comment storageComment = CreateTerminalStorageComment(terminalStatus);
            Comment inputComment = CreateReopenDecision(storageComment.Id);
            ...
            // when
            ValueTask<Comment> transitionTask =
            ...
            ApprovalStatus terminalStatus)
        {
            ...
            // when
            Comment savedComment = await CaptureSavedCommentOnTransitionAsync(
        ...
        public async Task ShouldUnpublishWhenAnAdminOverridesAnApprovedRowToRejectedAsync()
        {
            ...
            // then
            savedComment.ApprovalStatus.Should().Be(ApprovalStatus.Rejected);
            savedComment.IsPublished.Should().BeFalse();
            savedComment.PublishDate.Should().BeNull();
        ...
        public async Task ShouldWriteTheBypassFlagFromTheVerdictRatherThanTheRequestAsync()
        {
            ...
            Comment inputComment = CreateBypassApprovalRequest(
                commentId: storageComment.Id,
        ...
        public async Task ShouldRetainTheBypassReasonOnlyWhenTheVerdictUsedTheBypassAsync()
        {
            ...
            // then
            savedComment.IsApprovedByBypass.Should().BeTrue();
            savedComment.ApprovedByBypassReason.Should().Be(inputBypassReason);
        }
            ...
            ApprovalStatus notAnApproval)
        {
            ...
            inputComment.ApprovalStatus = notAnApproval;
            ...
            invalidCommentException.UpsertDataList(
                ...
                value: "Bypass requires an approved comment.");
