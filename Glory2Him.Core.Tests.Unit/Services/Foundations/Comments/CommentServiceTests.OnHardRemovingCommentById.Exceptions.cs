...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Comments
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnHardRemovingCommentByIdEventIfCancellationRequestedAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnHardRemovingCommentByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Comment> requestEnvelope = CreateRandomCommentRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyExceptionOnHardRemovingCommentByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnHardRemovingCommentByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Comment> requestEnvelope = CreateRandomCommentRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnHardRemovingCommentByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnHardRemovingCommentByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Comment> requestEnvelope = CreateRandomCommentRequestEnvelope();
