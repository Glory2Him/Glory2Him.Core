...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.Comments
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnModifyingCommentEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyingCommentEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyingCommentEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Comment> requestEnvelope = CreateRandomCommentRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnModifyingCommentEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Comment> requestEnvelope = CreateRandomCommentRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyingCommentEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyingCommentEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<Comment> requestEnvelope = CreateRandomCommentRequestEnvelope();
