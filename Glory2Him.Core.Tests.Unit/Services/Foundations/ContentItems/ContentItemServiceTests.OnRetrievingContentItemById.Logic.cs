...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItems
{
    ...
    {
        [Fact]
        public async Task ShouldReplyWithContentItemOnRetrievingContentItemByIdEventAsync()
        {
            // given
            ...
            EventEnvelope<ContentItem>? actualReplyEnvelope =
                await this.contentItemService.OnRetrievingContentItemByIdAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
            ...
            this.eventEnvelopeFactoryMock.Verify(factory =>
                factory.CreateNextAsync(requestEnvelope, storageContentItem),
                Times.Once);
