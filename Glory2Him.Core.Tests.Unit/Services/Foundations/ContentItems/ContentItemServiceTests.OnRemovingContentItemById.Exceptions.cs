...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItems
{
    public partial class ContentItemServiceTests
    {
        ...
        public async Task ShouldThrowDependencyExceptionOnRemovingContentItemByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnRemovingContentItemByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ContentItem> requestEnvelope = CreateRandomContentItemRequestEnvelope();
