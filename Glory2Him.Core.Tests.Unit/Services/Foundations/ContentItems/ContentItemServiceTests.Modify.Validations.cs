...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItems
{
    public partial class ContentItemServiceTests
    {
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnModifyIfSharePermissionExceedsMaxLengthAndLogItAsync()
        {
            // given
            string randomUserId = GetRandomString();
            DateTimeOffset randomDateTimeOffset = GetRandomDateTimeOffset();
            ...
            ContentItem randomContentItem =
                CreateRandomModifyContentItem(randomDateTimeOffset, randomUserId);
            ContentItem invalidContentItem = randomContentItem;
