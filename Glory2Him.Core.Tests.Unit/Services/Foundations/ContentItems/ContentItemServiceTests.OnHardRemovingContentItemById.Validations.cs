...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ContentItems
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnHardRemovingContentItemByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnHardRemovingContentItemByIdEventWhenContentItemNotFoundAsync()
        {
            // given
