...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalReviews
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnModifyingApprovalReviewEventIfCancellationRequestedAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnModifyingApprovalReviewEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyingApprovalReviewEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalReview> requestEnvelope = CreateRandomApprovalReviewRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnModifyingApprovalReviewEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalReview> requestEnvelope = CreateRandomApprovalReviewRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyingApprovalReviewEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyingApprovalReviewEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalReview> requestEnvelope = CreateRandomApprovalReviewRequestEnvelope();
