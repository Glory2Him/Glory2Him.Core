...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalReviews
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionOnRemovingApprovalReviewByIdEventIfCancellationRequestedAsync()
        {
            // given
            ...
            // when
            ValueTask<EventEnvelope<ApprovalReview>?> onRemovingTask =
                this.approvalReviewService.OnRemovingApprovalReviewByIdAsync(
                    requestEnvelope,
                    cancellationToken);
        ...
        public async Task ShouldThrowDependencyExceptionOnRemovingApprovalReviewByIdEventIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRemovingApprovalReviewByIdEventIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalReview> requestEnvelope = CreateRandomApprovalReviewRequestEnvelope();
        ...
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnRemovingApprovalReviewByIdEventIfSqlErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalReview> requestEnvelope = CreateRandomApprovalReviewRequestEnvelope();
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRemovingApprovalReviewByIdEventIfErrorOccursAndLogItAsync(
            Exception thrownException,
            Xeption expectedInnerException)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRemovingApprovalReviewByIdEventIfServiceErrorOccursAndLogItAsync()
        {
            // given
            EventEnvelope<ApprovalReview> requestEnvelope = CreateRandomApprovalReviewRequestEnvelope();
