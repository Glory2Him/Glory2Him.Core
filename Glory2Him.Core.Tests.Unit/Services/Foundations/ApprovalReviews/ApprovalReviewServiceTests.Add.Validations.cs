...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalReviews
{
    public partial class ApprovalReviewServiceTests
    {
        ...
        public async Task ShouldEnforceTheApprovalReviewTextCapAtExactlyOneThousandOnAddAsync(
            int commentLength,
            bool expectRefusal)
        {
            ...
            ApprovalReviewValidationException actualException =
                await Assert.ThrowsAsync<ApprovalReviewValidationException>(addApprovalReviewTask.AsTask);
