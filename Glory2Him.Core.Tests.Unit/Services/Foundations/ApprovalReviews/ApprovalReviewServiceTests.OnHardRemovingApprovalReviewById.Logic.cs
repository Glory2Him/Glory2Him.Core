...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalReviews
{
    ...
    {
        [Fact]
        public async Task ShouldHardRemoveApprovalReviewByIdAndReplyOnHardRemovingApprovalReviewByIdEventAsync()
        {
            // given
            ApprovalReview storageApprovalReview = CreateRandomApprovalReview();
            ApprovalReview deletedApprovalReview = storageApprovalReview.DeepClone();
            ApprovalReview expectedApprovalReview = deletedApprovalReview.DeepClone();
            ...
            this.storageBrokerMock.Setup(broker =>
                broker.DeleteApprovalReviewAsync(storageApprovalReview, It.IsAny<CancellationToken>()))
                    .ReturnsAsync(deletedApprovalReview);
            ...
            EventEnvelope<ApprovalReview>? actualReplyEnvelope =
                await this.approvalReviewService.OnHardRemovingApprovalReviewByIdAsync(
                    requestEnvelope,
                    TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldSkipHardRemoveAndReplyNullWhenHardRemovingApprovalReviewByIdEventAlreadyProcessedAsync()
        {
            // given
            var requestEnvelope = new EventEnvelope<ApprovalReview>
            {
