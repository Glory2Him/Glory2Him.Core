...
namespace Glory2Him.Core.Tests.Unit.Services.Foundations.ApprovalReviews
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalReviewByIdEventWhenEnvelopeIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalReviewByIdEventWhenIdIsInvalidAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemovingApprovalReviewByIdEventWhenApprovalReviewNotFoundAsync()
        {
            // given
