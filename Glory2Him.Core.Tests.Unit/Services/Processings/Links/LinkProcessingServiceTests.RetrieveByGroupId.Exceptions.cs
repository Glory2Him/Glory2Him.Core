...
namespace Glory2Him.Core.Tests.Unit.Services.Processings.Links
{
    public partial class LinkProcessingServiceTests
    {
        ...
        public async Task
            ShouldThrowDependencyValidationExceptionOnRetrieveByGroupIdIfDependencyValidationErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task
            ShouldThrowDependencyExceptionOnRetrieveByGroupIdIfOperationCanceledExceptionOccursAndLogItAsync()
        {
            // given
            Guid inputGroupId = Guid.NewGuid();
        ...
        public async Task ShouldThrowOperationCanceledExceptionOnRetrieveByGroupIdIfCancellationRequestedAsync()
        {
            ...
            // then
            await Assert.ThrowsAsync<OperationCanceledException>(retrieveLinksTask.AsTask);
