...
namespace Glory2Him.Core.Tests.Unit.Services.Processings.ContentItems
{
    public partial class ContentItemProcessingServiceTests
    {
        ...
        //
        // The processing service enforces the same visibility posture as the foundation (§14.6:
        ...
        public async Task ShouldRetrieveOnlyTheContentTypesTheNarrowRoleCoversOnRetrieveAllAsync()
        {
            ...
            IQueryable<ContentItem> actualContentItems =
                await this.contentItemProcessingService.RetrieveAllContentItemsAsync(
