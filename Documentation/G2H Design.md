...
with a prefix of its own. Three areas have moved so far: event design to
[`Documentation/Design/Events.md`](Design/Events.md) (§10 below is the pointer),
UI design to [`Documentation/Design/UI.md`](Design/UI.md) (§20), and security
design to [`Documentation/Design/Security.md`](Design/Security.md) (§14 and
§18). Everything else is still written here, in the section that already owns
