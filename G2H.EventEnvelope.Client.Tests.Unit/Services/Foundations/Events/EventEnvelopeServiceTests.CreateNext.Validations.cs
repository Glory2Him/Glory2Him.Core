...
namespace G2H.EventEnvelope.Client.Tests.Unit.Services.Foundations.Events
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnCreateNextIfSourceEnvelopeIsNullAndLogItAsync()
        {
            // given
            EventEnvelope<string>? nullSourceEnvelope = null;
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnCreateNextIfContentIsNullAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnCreateNextIfSourceMetadataIsNullAndLogItAsync()
        {
            // given
            var invalidSourceEnvelope = new EventEnvelope<string>
            {
            ...
            invalidArgumentEventEnvelopeException.AddData(
                key: "SourceEnvelope.Metadata",
                values: "Metadata is required");
