...
namespace G2H.EventEnvelope.Client.Models.Foundations
{
    ...
    public sealed class EventEnvelope<T>
    {
        ...
        /// </summary>
        public EventSecurityContext SecurityContext { get; init; } = new EventSecurityContext();

        /// <summary>
        /// Operational information about the originating request or process, used for tracing and audit.
        /// </summary>
        public EventRequestContext RequestContext { get; init; } = new EventRequestContext();
